...
test_type("list", ssh_config("ssh://remotehost", tunnel = "5555"))
...
connection && {
  ...
  test_type("character", launch_remote(remote = ssh_config(remotes = c("ssh://remotehost", "ssh://remotenode"), tunnel = "5555", command = "echo")))
  test_zero(daemons(0L))
  Sys.sleep(1L)
