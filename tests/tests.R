...
connection && .Platform[["OS.type"]] != "windows" && Sys.getenv("NOT_CRAN") == "true" && {
  ...
  test_zero(daemons(0))
  test_zero(daemons(url = c("tcp://127.0.0.1:0", "tcp://127.0.0.1:45555"), correcttype = NA))
  Sys.sleep(1L)
  test_null(launch_local(nextget("urls", .compute = "default")))
  ...
  test_zero(daemons(url = "wss://127.0.0.1:0", pass = "test"))
