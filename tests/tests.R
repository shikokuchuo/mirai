...
if (.Platform[["OS.type"]] != "windows") {
  ...
  nanotesto(cpinfo("n"))
  nanotest(is.integer(cpinfo("pid")))
  nanotest(is.character(cpinfo("urls")))
  nanotestn(cpinfo("tls"))
  nanotestz(daemons(0L))
  Sys.sleep(1L)
...
if (Sys.getenv("NOT_CRAN") == "true" && .Platform[["OS.type"]] != "windows") {
  ...
  nanotestz(launch_server(cpinfo("urls")[[1L]]))
  nanotest(is.list(cpinfo("tls")))
  nanotestz(daemons(0L))
  Sys.sleep(1L)
  option <- 15L
