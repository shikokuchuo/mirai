...
* New `cpinfo()` utility for retrieving information for a specific compute profile (the dispatcher process ID, daemon URLs, and generated TLS configurations).
* Requires nanonext >= [0.9.0.9024].
