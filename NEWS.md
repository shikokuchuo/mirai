...
* New `cpi()` utility for retrieving compute profile information (number of daemons set, dispatcher process ID, daemon URLs, and generated TLS configurations).
* Requires nanonext >= [0.9.0.9032].
