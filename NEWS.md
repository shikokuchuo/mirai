...
* Adds `mmap()` for parallel/distributed map functionality using mirai. This function allows recovery from partial failure or else early stopping, together with optional progress reporting.
