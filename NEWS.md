# mirai 0.13.2.9007 (development)

* Re-implements the promises method with completely event-driven (non-polling) promises (thanks @jcheng5 for prototyping).
* `stop_mirai()` now returns an 'errorValue' 20 (operation canceled) in the case the asynchronous task was still ongoing (thanks @jcheng5 #110).
