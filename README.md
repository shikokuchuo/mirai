...
``` r
m$data |> str()
#>  num [1:100000000] 2.85 3.63 0.25 1.23 -1.45 ...
```
...
call_mirai(m)$data |> str()
#>  num [1:100000000] -2.1689 3.1048 0.1179 -1.269 0.0924 ...
```
...
#> abstract://fa3b45a0e2d35f5f97b82898742aa0cbd198bec1      1        1        0        0
#> abstract://334ead7a516f80c4c69b45ecae45e99d1ecdf343      1        1        0        0
#> abstract://0620a1e9c722af1e357e710228aa20f9f7e41a1b      1        1        0        0
#> abstract://154b6c85497a8a38d5872e3c6b3df1f2a5771c77      1        1        0        0
#> abstract://94ed649b5329764d0f68946ade8b99650ca5b0d4      1        1        0        0
#> abstract://8cbba13ba2c6db84a51aade8c6f52ef3eeb272a1      1        1        0        0
```
...
connects to the client URL and receives tasks:
    ...
    Rscript -e 'mirai::server("tcp://10.111.5.13:37421")'
