...
This allows tensors, including objects such as models, optimizers etc. to be used seamlessly across local and remote processes, the same as other R objects.
