...
Calling `daemons_view()` will now always show one daemon. However network resources may be added and removed as required, and tasks are automatically distributed to all available server processes. The number of connections will show the actual number of instances connected into the client (2 in the example below).
