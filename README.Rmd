...
The generated TLS configuration is stored in the compute profile, and may be
retrieved with:
...
Note: the 'client' portion should be passed as the 'tls' argument to `server()`.

Alternatively, a certificate may be generated via a Certificate Signing Request (CSR) to a Certificate Authority (CA), which may be a public CA or a CA internal to your organisation.
