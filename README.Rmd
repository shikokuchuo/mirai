...
Simple and lightweight parallel code execution, local or distributed across the network, built on 'nanonext' and 'NNG' (Nanomsg Next Gen) technology.
...
{mirai} has a tiny pure R code base, relying solely on {nanonext}, a high-performance binding for the 'NNG' C messaging library with zero package dependencies.
