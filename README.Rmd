...
m[.flat]
```
It is designed to facilitate recovery from partial failure by returning all errors as 'errorValues', and also has some other [advantages](https://shikokuchuo.net/mirai/articles/mirai.html#asynchronous-parallel-map) over alternative map implementations.
