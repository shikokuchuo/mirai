...
`mirai_map()` maps a function over a list or vector, with each element processed in a separate parallel process. It can also perform multiple map over nested list/vectors, allowing advanced patterns such as map over the rows of a dataframe.
