...
Extremely simple and lightweight method for parallelism and concurrent code execution, locally or distributed across the network, built on 'nanonext' and 'NNG' (Nanomsg Next Gen) technology.
...
A ‘mirai’ evaluates an arbitrary expression asynchronously, resolving automatically upon completion. The asynchronous task runs in persistent or ephemeral processes spawned locally or distributed across the network.
