...
Above, a single URL was supplied, in which case a sequence is automatically appended to the path `/1` through `/4` as 4 nodes were specified.

Alternatively, supplying a vector of URLs (the same length as the number of nodes) allows the use of arbitrary port numbers / paths, e.g.:
