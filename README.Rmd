...
~~
<br /><br />
{mirai} has a tiny code base and relies on a single package - {nanonext}, a lightweight wrapper for the NNG C library with zero package dependencies.
