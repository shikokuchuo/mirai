...
The return value may be deployed manually on a remote machine by unescaping the double quotes around the call to `"mirai::daemons()"`, or directly via SSH or a resource manager by additionally specifying 'command' and 'args' to `launch_remote()`.
