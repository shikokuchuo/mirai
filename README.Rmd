...
1. [`mirai.promises`](https://github.com/shikokuchuo/mirai.promises/), which enables a `mirai` to be used interchageably with a `promise` in [`shiny`](https://cran.r-project.org/package=shiny) or [`plumber`](https://cran.r-project.org/package=plumber) pipelines; or

2. [`crew`](https://wlandau.github.io/crew/) provides an interface that makes it easy to deploy `mirai` for [`shiny`](https://cran.r-project.org/package=shiny). The package provides a Shiny vignette with tutorial and sample code for this purpose.
