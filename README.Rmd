...
On the server, the `server()` function may be called from a suitable shell (e.g. using Rscript as in the case below) to set up a remote daemon process (here '192.168.0.2' is the network IP address of the client):
