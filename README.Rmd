...
`mirai_map2()` is a variant that allows mapping over 2 lists/vectors simultaneously.
...
m[.flat]
```
All errors are returned as 'errorValues', facilitating recovery from partial failure. There are also other [advantages](https://shikokuchuo.net/mirai/articles/mirai.html#asynchronous-parallel-map) over alternative map implementations.
