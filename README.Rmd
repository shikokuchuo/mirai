...
A dispatcher running local daemons is self-repairing if one of the daemons crashes or is terminated - a replacement daemon is launched upon the next task.
