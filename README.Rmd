...
Alternatively, [`crew`](https://cran.r-project.org/package=crew) also provides an interface that facilitates deploying {mirai} for [`shiny`](https://cran.r-project.org/package=shiny), and provides an 'Asynchronous Shiny apps' vignette with tutorial and sample code.
