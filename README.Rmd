...
Requesting the status now shows 8 daemons, but only one connection. This is as the queue acts as a switch, relaying messages between the client and individual daemon processes.
