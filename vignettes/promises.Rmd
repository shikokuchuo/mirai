...
- Do not require each promise to be polled for completion by a `later` loop that re-runs every 0.1 seconds, which is how other types of promise are implemented.
