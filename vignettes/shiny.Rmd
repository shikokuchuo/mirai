...
3. In the server, create an observer on the input button, which invokes the ExtendedTask with the *named* parameters required by the 'mirai' i.e. 'x' and 'y' in this example.
