...
``` r
m[]
#> [1] 3.134849 3.178784 2.883315 4.949852 3.348789
```
...
m[]
#> [1] 4.871389 2.156126 5.754050 4.892155 5.459129
```
...
#> 
#> $daemons
#> [1] "abstract://9d05069414406d1dd83896d4"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "abstract://b261db4e366f3a27d2d25cb7"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                            
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpZFpEmz/file1143c6d67f7da\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                                
#> [5] "  ..@ flags              : int 70"                                   
#> [6] "  ..@ vfs                : chr \"\""                                 
#> [7] "  ..@ ref                :<environment: 0x5e61c854a210> "            
...
launch_remote(2)
#> [1]
#> Rscript -e 'mirai::daemon("tcp://hostname:38093",dispatcher=TRUE,rs=c(10407,-979460547,-330641446,-732920941,-1631923272,1813242457,1891878470))'
#> 
#> [2]
#> Rscript -e 'mirai::daemon("tcp://hostname:38093",dispatcher=TRUE,rs=c(10407,-2050707818,-949505249,-358304540,-1819501694,329108736,1365818545))'
daemons(0)
#> [1] 0
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://hostname:37943",dispatcher=TRUE,tls=c("-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAKdOSDul3wo55O8nIkj5QQf+nGG0EyIOR7SG48ZFh6eJxsUwLu/s
#> nFRP9aY9m/OJSLCDQ6Onnpt0XNpBfaOCA5Vw/24dkiwWcv3J2V3FSEyKvtkNTNF8
#> O8cIuxwR8sKfyenpkMMV5amGHlV96IF7+OBvfteTErtajoYP/+XMxLLEydVJIJbZ
#> kQ7wI6jHuBEiXzSIfZ0BLE0slqCEuxDkdStgZEQusX+VJ6NGNt60HfzIEHi1oule
#> 4A1vkKpH+noBgB5PmmUfDDI1F2+kDsvU9q1Sx/xgeGgCnIM9zfKY4EPeANAcdCto
#> 7DGSi8TGbMZqfbFTbTlSoAwlDMbAPvCi0/oHL6/CHo7x2GP8iK53DINoaeC3HcWI
#> npOGeeyHOCFrbOWXJorq9q8RjbYXiCP/zXxKA4t37fwwtuISEDQg3jP7bjHzTEz3
#> +mYnAbK/yN4+lUpA3zXnMzBxQMGEaHjaZRvS33UcrcVNss04bh060E98WyGfVCCF
#> v0RpzCfWg/xKh9f1uNYBXUIuLDUnL1DRJ5O6V12E+NKbkKmDI2vGFolIEMGVK3JO
#> ccIMvZ7QHsioL9K2otHiP43bhwoDwvCLEsJjApVN1Q68KIFZBo8f88txhKSvKkjx
#> uPVlPX34XjHfNWTl9EUX+zbMp9MkSk1PaReh6iCKWuXMH5K1uTUr/M2/AgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFAk/VDcrYZRPT4QNPusF
#> AWyIBZ6CMB8GA1UdIwQYMBaAFAk/VDcrYZRPT4QNPusFAWyIBZ6CMA0GCSqGSIb3
#> DQEBCwUAA4ICAQBAyRuslp7VoFm+I91AhI4s1rIXmiNZwxP8rOPOhqQKk6wF5MMS
#> FESnMcUKs1wzIHJ7OeMfYJb+Z99p3oTBDfF0lAEyQvatOm5+DRzL2oZ6ZAoMk6CA
#> 9ZZ/zUcF2wiIsyO5J6z8PkbLwXUjHAM68HANxOgjh+jE3Mt00vJfSNmK4G0KwnDT
#> ygVVpSLu93muKbRS+RVJQP6d2SkfOziL1ESMwsza9LT/wbwhSK0D0qoIP54VeU8j
#> lGjeLNBZJP+BB0V8F7CbnPs0t37iecmm13CqARzAP4t0mpyq434xBi7xTWwWWC1g
#> Gdanr6k8vL+0kEyBvUsJRkAe9qocG9fT8QRsp6a8KZu09WiS2UhETlJTnXTM3bAM
#> cifPFJcUHd2RS+wsBtFqq0eDz3DI7E2MwUvpMwtTkNpclaOD9yTEBNrEpTSo8Hkk
#> jwRozEc/WmotJdRb051LIhqctziLK5DQ/KULqmpYwyW8Y/wnKH9LxzMFhw4ies23
#> OaCnc+L0Jver8lDfcAhSPvK4W0udO+/l7WtIZGjAmmGwarYaE8M+Q7R+RW821u6b
#> wBOEzFy/t9QISngWHUeMRQXYn44lpcyV1o5D64S8dPTI/nbmKRR7GhkFuIeYF0sG
#> 5G0DjIRmDsjQHCz8E7qkfOOWPxa2k+46IItqfy9IYFRGCi+b5UELXV4rpA==
#> -----END CERTIFICATE-----
#> ",""),rs=c(10407,487807269,-1658174558,1139368635,-1633513792,-668201023,1742105230))'
```
