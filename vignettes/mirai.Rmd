...
```r
m$data |> str()
#>  num [1:100000000] 6.09 4.26 4.79 -2.27 -1.66 ...
```
...
call_mirai(m)$data |> str()
#>  num [1:100000000] -0.794 0.466 -2.023 -1.432 1.419 ...
```
...
#> abstract://d7ed73e628c513282dff2e80 1      1        1        0        0
#> abstract://fa9e6ce38dffd793fc862b9d 2      1        1        0        0
#> abstract://bf7ef65469ddd47de36997ac 3      1        1        0        0
#> abstract://3eb4eea3567f438378b70b1b 4      1        1        0        0
#> abstract://adabe42ef46f995cb8e5d2e2 5      1        1        0        0
#> abstract://b75c19ca731a66232f408c62 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://525746761a227cc77c569ff6"
```
...
launch_remote(1:2)
#> [1]
#> Rscript -e "mirai::daemon('tcp://[::1]:46719',rs=c(10407,-563885221,-224889120,2030080353,2117556142,963841111,-451392340))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://[::1]:38745',rs=c(10407,-1014469919,-1562435391,-1904939407,153006146,-545844219,483234149))"
...
launch_remote(1)
#> [1]
#> Rscript -e "mirai::daemon('wss://hostname:46409/1',tls=c('-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAL4g7GSftSvv5Vl+GBjDArDDeE0tK1vIP0VxjpLPXCm1s7/EqpzR
#> azLg/sTe9ysYtaq5elDiL6sUW9Qf6FMBsT0oJwUT2KB3h3AWXBYgvn6jIUbqpICd
#> ANzDXk3W0XOBJobF1COCRosYvdjImPih6Dp9RmOrLyvRGDwTbAH4yvWTenkBfMYD
#> gv9bBU+Ik10JD1Q2vAl0YduBnXf9FDSvwOgFke8XNAApUCPhY6A0b2zMsNKQVnDI
#> sq1oiSw0a9Ewqa3RIn+AjkdGI7i58CEKLDDVzoEwZpu1Yt6oslefu/hEfnkGay7y
#> y8FV7k/W1jBbgv1sENcLeSXNtPR0Eppr+mgL9UcOtxHK7xJLWcGzxISqgtdb7K+w
#> MzE9K6YC5rZw6CKMy8zgg5W/iiFl1GPhjvOmgvaKUTRxYkcCLVGdzlnji02BNqtG
#> 8NvmjcJx+jfWEByGe9BjdqatjOKq2XtXPY4SaIN9+xlID+ZLnD+K+6Cd6HHjK9Uy
#> jgeVG5to84wY5QccL6H3RM6DV2NAAsQdBW2tpKxabGQ1swRgnrVpLtR3QVhP2u8F
#> lSUp9RpPph4nzLcYYCgR3AOZAw/qa9me0ThYDA44pFTMzNcYezlW689xk6+h7DAH
#> 5G3BepI6YKyquh6+BT9L0R6xGI9q+2Xr4/1HrKNw9aZR7O+qMhRB1duzAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFI31LoKIiW1lDur7pDk0
#> 9DJCC2U3MB8GA1UdIwQYMBaAFI31LoKIiW1lDur7pDk09DJCC2U3MA0GCSqGSIb3
#> DQEBCwUAA4ICAQAfNz2vzURQnmHq9yxG9ChgyUyauWIWcUa5dGQifjLxVvbsWkSO
#> Mnb2wzYNd3UrrpWMli55L02dCbjJu5vqqT4DwKFBIc3DhfRl0rfX8gKvkfgDltHT
#> zwO8w06rZy4dLzvfFwsU2SMuRVdOSCYo/SG3nVGex20s2DvoKZzr0EgsQz9vwOTL
#> sTTd98U4fiYO3nyVePSiX6StQwz+vzhxZkD1exH3+WIzWVCo24eI7go3jJzTy9rW
#> hBoDKmRDE1ldO0ASsWXxjs7qX3Ld5+mDgh8xar3RUO21DY3mTNdYag9SaQPX8rAI
#> +w2mUSfQp4T81PGZlC8g8LfxCC8T4J0R8Orxbpi2on7dQSk1zWljMfTm/aRih/GK
#> ajUX33Ssbjzz1pcwyF8MnD8A1Dn6il3ZfCSWrCGRp2hGWOwAlvisa1+lDNS8uLBd
#> DgLIlEWLVyssRCsMyrbDUts/4mP9VG7Bv8EjkjFgZZ2ljrUU+M1iqLwPKE7TwlQs
#> BKmloMRMH82xsm2u7yfN6eHXP5LwGVHtxO6GdB8AyMNlxwPTSKjBg8r8SNCQN62n
#> JE0daFYmpBBGBLIwl0nJomeUFjo2OKe0QRws3XcMULMCPEYlAFr1HxADOxQljlxP
#> UWuvvZbXho1DEoxtM3Qg9tsvw+5HZo8GO+bi+lokeuRlRP12EtGTvYKF5g==
#> -----END CERTIFICATE-----
#> ',''),rs=c(10407,-770219130,-800161713,1269809732,1256195189,1511162546,-1809337717))"
```
...
#> 
#> [[2]]
#> [1]  2.53161611 -0.06227691
#> 
#> [[3]]
#> [1]  0.5195079  1.2031813 -0.7344067
#> 
#> [[4]]
#> [1] -1.6092451 -0.8493915  0.6429945  2.3526165
#> 
#> [[5]]
#> [1] -1.6987580  0.1466959  1.8268763 -0.7961872  0.1861142
...
#> 
#> $daemons
#> [1] "abstract://53c1fb59f9182e29fb9f8f45"
...
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:40741',rs=c(10407,256955411,848415288,-1338259751,-271564602,-573313905,1380364676))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:40741',rs=c(10407,-1887117752,-411149752,-1914451116,-471450958,307344638,2032680824))"
