...
#> abstract://fc635810a90c1a997e9d913b 1      1        1        0        0
#> abstract://1d5e6e71a9e9484ae170aec9 2      1        1        0        0
#> abstract://49ad03f70a82c4289d1132a7 3      1        1        0        0
#> abstract://95e583e6139abea16a36c876 4      1        1        0        0
#> abstract://0bcbfbc18103297ad9b307be 5      1        1        0        0
#> abstract://291214bf2ced23ea70edf46c 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://b46506cd098b683b01e5ed86"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                           
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpZl55KS/file66f17cfebb6e\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                               
#> [5] "  ..@ flags              : int 70"                                  
#> [6] "  ..@ vfs                : chr \"\""                                
#> [7] "  ..@ ref                :<environment: 0x570dc04b5a00> "           
...
launch_remote(1:2)
#> [1]
#> Rscript -e 'mirai::daemon("tcp://hostname:36017",rs=c(10407,1337893689,757832102,-60983313,1306471780,-563516139,-502568238))'
#> 
#> [2]
#> Rscript -e 'mirai::daemon("tcp://hostname:42113",rs=c(10407,-541702982,-1378519452,-1915161427,2040511433,-1991550749,1412808583))'
daemons(0)
#> [1] 0
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("wss://hostname:37651/1",tls=c("-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAIm+XBG264/8Ss0Ew+s2k2WdCZ6HiuDm9YpoxA8WXYs1UlkSm6ZA
#> bdcnJTqv+FBH2SMSlA0A9Q2GxL0EeiK4rz3MTo3KspiloYYheGUY1MijMT3XekIt
#> hG6QckEajoly6vbhj4FcIfw64siQEtosWnqhdxbMwon+2k8SpPOcpMtM/oy02tvW
#> Sjz/VxX+MZZby5ZAEgDGeQaE5IX4ZHEAL249nWqboCzR3TI+314kOTO57bJHSF/e
#> boXj35gsvWiaADYpL7VOgjk7vnP1onCran7YSilvOOh6ef7Lec+NHkL1ARKwh0er
#> OwYrH6J65w+e0+EGfpSHSvsyj7psBQlZKCva9JxTd8F5NGCc5yog3UqKSaKvuzhc
#> woqvtVp2Q/FADEMONRiB3jV0ZcWHD5UF1DqwugBOiM6osH2pLKXCfbwnXXkv55bx
#> 2u35d8F8ZHazhq6lJdgtwtyhPJXfjqp8gx8BlETEHDdr0Xlur0FUkXb+RLWCCQLu
#> qsmE3LQvFHnXovzA2KWL0pGYW812ZVjOy8NDEEWRqkAypcr8eOiFDuY394e6Je1s
#> lbpxhesKbEN5WdozgD7QqaIajAhTGt2vxYynPNHzR6o8FraKVnOrnslVYTrJPhdK
#> VnXZLW36GvJjkXwfpsbeaP1jaPrmn3mhSocboKRM62tydlw2kSygTccFAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFKcw8F/nL5+prrswL+Y4
#> gpo6XKUfMB8GA1UdIwQYMBaAFKcw8F/nL5+prrswL+Y4gpo6XKUfMA0GCSqGSIb3
#> DQEBCwUAA4ICAQBDCaOS8njwyrI8qBv4WV4Ju3tJjy7xDSiaVKM8i+eraevo67lG
#> H2zX3HxwWHj4dKxVdGxOtO3V5GiHoDD+WVFC0oGygzNUpNmmdGOj5u963fUUiXSI
#> HuPLGvyYsydYEJqKKmgm94sXzu8dAfVzx1aA34VIPWLx9VbyoE/FnwSV26SFbhH8
#> yH9WEdosKySTigcI/FnD6fr06y+4IVu/WqqWMqclTtvVsfFJTEdjNCj3hp8fcp5+
#> RJ9Sqy9+Q8kNdGBNeiHa1+Ud8VI/1fh5cm24Kn11vEN29SJuPL6CToSXRzPOoF3y
#> WN8PglNLtFSoo8jY4YM4d4pCHKHhapRpdOBfDAg2v0Rm58xUtnlAY8sT1uAQ3IHM
#> RKh91ItzeowulKXLhaC+csMQvyzpZ7JiBa0cYcsc14yEL94+X+umRy5mKGVzdoC/
#> D7lJqGmTwQiXZicxLtX/jSYcxg5htoHaTZ0dOE1sTdRrvx+j02ikrNkdAaw+pFEc
#> 5PCdWmohw8lGj+fLmAEsBt/A6u4yvSbT7OcBZmfHEZ1sRR5S4Co0iTBFAcAMBIsW
#> mFg0cIqyb2zyVUcxwnmSpOSFa+yTIK/D04tsh03Szamid6ML5iSRD1xP9GphG6Md
#> /nqdi06lhrPHU2m2pbklkkREbim+pWAEg/OKU77LHa9TsUW+3TRw/gDwpA==
#> -----END CERTIFICATE-----
#> ",""),rs=c(10407,-1563504785,-1349271836,-656052075,-955795374,2111620011,-1016897808))'
```
...
```
However, `serial_config()` can be used to create custom serialization configurations, specifying functions that hook into R's native serialization mechanism for reference objects ('refhooks'). This configuration can then be specified to the 'serial' argument of the `daemons()` call.
...
As another example, we can try using [`polars`](https://pola-rs.github.io/r-polars/), a 'lightning fast' dataframe library written in Rust (requires `polars` >= 0.16.4).

``` r

daemons(2, serial = serial_config("RPolarsDataFrame",
