...
``` r
m$data |> str()
#>  num [1:100000000] -0.419 0.519 -9.187 1.71 2.207 ...
```
...
call_mirai(m)$data |> str()
#>  num [1:100000000] 0.165 -2.377 -4.71 0.704 0.968 ...
```
...
#> abstract://f5514df5f0a73e63f9234174 1      1        1        0        0
#> abstract://c74f779dd18d0ed6880ef933 2      1        1        0        0
#> abstract://539cf2db822436b797d3cf56 3      1        1        0        0
#> abstract://90ec085764d65c3987ec8244 4      1        1        0        0
#> abstract://fe59c94fa2090d2ad22c9020 5      1        1        0        0
#> abstract://004fc121cf9f9142a68e2633 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://8a737d726d0f51530f122f93"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                            
#> [3] "  ..@ dbname             : chr \"/tmp/Rtmp9UvxCY/file1bff731a794ff\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                                
#> [5] "  ..@ flags              : int 70"                                   
#> [6] "  ..@ vfs                : chr \"\""                                 
#> [7] "  ..@ ref                :<environment: 0x5feedb7f6990> "            
...
launch_remote(1:2)
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:41359',rs=c(10407,-777907640,738085801,1881353046,-1062006305,2032968340,-275532667))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:34057',rs=c(10407,-1197936374,12525041,-578490495,1494386063,-1693961187,2077512675))"
```
...
launch_remote(1)
#> [1]
#> Rscript -e "mirai::daemon('wss://hostname:40359/1',tls=c('-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAKW9qNR8MA/g0jZ8kWZlvBUwprvC+0eB2k1if3PQi9BpruPTBuuH
#> kiim+IMeRUBR5EeQTtzzCA0FFFmAh07UlKE1xXsDyIhCq6/V14k1IBOkzsbqnSYR
#> WlREAf4VIqVRckbzEp0ShwYJtRNl0Og0RZ9/Tc2Vh+kN5mEGpSzwpd/n3W2shuVf
#> EiCZT8LWzamTdERM5mZaICGUe0Bi4JG0ppGNcV2h7iRqfcdU12d3Ixm9c1XDihjC
#> Mi7EWoq/k+UnCPJ6b1b9AhsuLf5xkAq5JAoe3Bt1XYzwM1NRKMA7l2hS1dKu1rHO
#> I1+0t+khOqB6AXcFQDwq1YDTpFRn+4oLeBoy68RIPl6sLETfoYj9eiqBb9FT1rAh
#> 4CL1pYy6pL1dhB0XHHYZTixY/4CUb5vReN3NC6Vw1uJrLETS63F2X4ih7bpBqG8R
#> ZSe+zT8ykvKaPAnZHr8RAYcqYuersqW3ZbBBAPcWC0XXvbop+qDR/2MFKEWHEDB5
#> gBqc5aEF+z/b2EtfQQ/RxVC6peCUhEMHFgyGWCh0q5zvMWJw0alq39I6I/AEIPT6
#> jxNPWrOTQp6q9Sfpdz8x7QNYkf2zqboB/0CCdKLbUP2BGKpTOp3zc70055Ecxdh2
#> ybnGg1pLrhBIUUeRbCdbq9Nuz8mwzaHf57BLESorctEiHvsulFuelGG/AgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFJ9ntZvq+B00NcfDN0TM
#> Yn3U6oCdMB8GA1UdIwQYMBaAFJ9ntZvq+B00NcfDN0TMYn3U6oCdMA0GCSqGSIb3
#> DQEBCwUAA4ICAQARigOSQiIUS8Nqa/2r3MsdbweJreMIHVAtXvh8HzhyYjqx6TYe
#> 8ou9El1Zowp5bvI9aGvAXfZC28UN/ibJeR+SrdKfoRqN93n5jpzqbNSMVyH7Mk+2
#> W80xN6Qy21CL2Rw73g085uzm988FmXbYe+hftccEKUNe7AQWdJOtau3mm+37dY1S
#> a1EFQJhB6EnLQcuzcQeOwm7Qj8XZxq9V6prRqy6kuJ1/VNv7xXoHF6klmZ5MGdzr
#> wL6X/4w+6a/mjTaTvi3HylS2U8c2s/gipW5X5UwnsWC3I4CMJBZFcvFY+WZcRA4d
#> lZ09D6WiQ0XLLG/lobfLBIp9oitON88F6hzrMxLM4muRSCvrbqHCSgXPrAioxbdE
#> XHU3/fqHerLmqnQopemeagZ5kWugIiUddkis0EhPuZrxZX6ukvyH+iO6HbGqNrVo
#> J+/8rcv+F63Vzrf/tMWOCwLkVclK2MItdl/sCjSIP9onQKZEIZNBmW/lSB6bmwNy
#> 2pSMXK41KzgjDLf1uSYsDZqWkVmgB2JuflteaWG+ITxiVxicnZUH0C2/VUomBip4
#> RtCa8RyZfasGARQyhUOkMhI2OOjoV7twJK497bRAMZpAZIH82qjwTPJly7GNywCH
#> bhL/3u/KVXEOpb/+/Z9+bOczvElG1S/ZExwz2OKLxzE2iDIlfHj87oErUw==
#> -----END CERTIFICATE-----
#> ',''),rs=c(10407,744259333,-1215694846,-216681573,1981461024,-1601420383,-211659538))"
```
...
`mwalk()`, short for 'mirai walk', is analogous to `purrr::walk()`, although completely asynchronous and returning a list of 'mirai' objects. `mirai_data()` can then be used to return the values from `mwalk()` or indeed any list of 'mirai' objects.
