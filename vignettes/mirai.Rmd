...
11. [Promises: Async Plumber Applications](#promises-async-plumber-applications)
12. [Custom Serialization: Torch Parallelization](#custom-serialization-torch-parallelization)
...
```r
m$data |> str()
#>  num [1:100000000] 2.337 -0.657 5.658 1.532 -0.709 ...
```
...
call_mirai(m)$data |> str()
#>  num [1:100000000] 0.0877 -5.0171 -0.8708 0.9943 0.6127 ...
```
...
#> abstract://27be63c227ca802524081219 1      1        1        0        0
#> abstract://33485e0762b0f453ec334131 2      1        1        0        0
#> abstract://c0d25cc483b6d69f25306ee0 3      1        1        0        0
#> abstract://12586a9eaf2ee23307913851 4      1        1        0        0
#> abstract://c9abad150c05ac3c52b2b893 5      1        1        0        0
#> abstract://a3a614e2663a0180bbb83e06 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://68430c22175d47e2b09e9ec3"
```
...
launch_remote(1:2)
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:44645',rs=c(10407,9120164,-1439585195,2078036242,-1331899029,970479024,-1538880015))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:38975',rs=c(10407,-233327381,1183997068,-969637394,-134628018,-1315501271,925476953))"
...
launch_remote(1)
#> [1]
#> Rscript -e "mirai::daemon('wss://hostname:46869/1',tls=c('-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBALWoIi/dgLPMjsCVsIX5n38guONvOajTkl4Zm+wy3wd9Wi6WW4d0
#> 13Bdjhn/EM7K1x6yckhIXehdWxmED5cN9VC2SLYqiwUGgqjSwQrHxqaN03ZQI+D8
#> LMdvFaq48j0Lh0eBgYDGYS0A0Geto4z6phHzidCug3r73xXxAeGsKc/Cz/TJzhzf
#> Iush3FYWR/fC4sI8m/7uU+5AOS+NFc6mryTQZsUbtYHMG+ghEO432dYgpSzYE00S
#> 5xtLUas+wbKktl/Xb5UDLppQKSwoCZX+1G41cgY/dwmhgbqLYSwORJkzhtJRdI7O
#> hW0aOYi8u/Ca3O+JRb/J2SnSP6S5KVAin6P8EH7qX5ZII7RPNF4LTSBwOO6EAmF+
#> AvgqE7SZFu1FFDjZIldnI8JjmD4nzPcePnD1aGO5NkdfwMxtLFcwququkDvD/me/
#> PaKhO9sbqMpyjWuorXTbjLIhNeHRbZuEiWC2j+8pJFlKTIdBoL2o4dTVTD2thKH6
#> Sx2EqJJxXxXfgLeYM+7q+10C9QR80+W6/Qov94/arUawz8StXYmA38yUAdiVaoY1
#> Nx+L22/Aut+e3qN2kDUYGrltgWjqVt8lqTr/mDf9woVADNeYcGvI77afRej3E+Vn
#> tV9sHzMQjLNu6QeXt4rt0s68mdxB6uvQNpvQvuZxgf2licBpqOMVimZnAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFB6tesb9kS6JiLZjBvuj
#> l2eL8Z3uMB8GA1UdIwQYMBaAFB6tesb9kS6JiLZjBvujl2eL8Z3uMA0GCSqGSIb3
#> DQEBCwUAA4ICAQCMGL+oK7JWFEEO9WmqPgezxBOMt4mVHNjZLoFV4qOYbhhYGuej
#> VCFe6t1boGFNttYG3DmEqG/5ghFlHyarj0x5jJnVm57V0N8wYZ8q9rsjJdZxyiRY
#> fK5JjyjniKhSQ5zoBdwscUvQi3edoOY0K/A57UGn6Wy3nIMUJ3nn4gX2f1CU2VB0
#> eHeN+TzKQ64STDljGcejH24tQ4dGLz5aOPTmic5UyYjrDZYhgubiMGIjoS13i2f/
#> 9pXbXfL9HZA+W7H3tj/FmAF2raLMiCG4CM6iPOfNBnQlu4bHPTalrDtui8G+R0hO
#> M7DTnrxkd2yUiltTe2hXdaG9H3gh/Rel898Tx8w9POKNMjDYnWiiNArYhVWwl4oI
#> r5se5YfXXpu0mqsDd0NDLVkrBV3Bf20nyx5+jDx4L3pzkdxLTj9ETgVif+6h3rIe
#> +oq5KfjQb/TYt2pqzSVRUziyVwDyFneTc/8uwE4fSAkZXzdjwFbXfF7xl/muOR6s
#> 8VIpXVNfpc1YjgNmWC0lktbH7+sYgdFIfgkuks85lYBJCN7vz1JZDtDMvsgVZc0R
#> zz35d9ul6CP2IYwtopo81Mrtqa3L/DH+7uLSHb6T6SNkvCo6XxNlFUnAQXzbxR2r
#> FGlVo2b61RPJ8aaQ9z6Ac0LW8q1eEVgXqNQOPpKcRmVFd1yvbUSbLnza2w==
#> -----END CERTIFICATE-----
#> ',''),rs=c(10407,2011144383,-100897804,1821496933,789630946,1525084667,1999930624))"
```
...
#> 
#> $daemons
#> [1] "abstract://0dbac0e54e251bf1171372a9"
...
#> 
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:42945',rs=c(10407,1041538617,1623496870,299150063,-1091959708,-939354091,-471737902))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:42945',rs=c(10407,-235974487,53244630,684539885,394113573,439946321,-1002020066))"
...
#> [1] "{\"time\":[\"2024-01-09 11:39:01\"],\"msg\":[\"1\"],\"thread_id\":[18136]}"
#> [1] "{\"time\":[\"2024-01-09 11:39:01\"],\"msg\":[\"2\"],\"thread_id\":[18132]}"
#> [1] "{\"time\":[\"2024-01-09 11:39:01\"],\"msg\":[\"3\"],\"thread_id\":[18139]}"
#> [1] "{\"time\":[\"2024-01-09 11:39:03\"],\"msg\":[\"4\"],\"thread_id\":[18132]}"
#> [1] "{\"time\":[\"2024-01-09 11:39:02\"],\"msg\":[\"5\"],\"thread_id\":[18134]}"
#> [1] "{\"time\":[\"2024-01-09 11:39:02\"],\"msg\":[\"6\"],\"thread_id\":[18136]}"
#> [1] "{\"time\":[\"2024-01-09 11:39:03\"],\"msg\":[\"7\"],\"thread_id\":[18139]}"
#> [1] "{\"time\":[\"2024-01-09 11:39:03\"],\"msg\":[\"8\"],\"thread_id\":[18134]}"
...
Querying the endpoint produces the same result as previously.
...
res <- lapply(res, call_aio)
for (r in res) print(r$data)
#> [1] "{\"time\":[\"2024-01-09 11:39:06\"],\"msg\":[\"1\"],\"thread_id\":[18415]}"
#> [1] "{\"time\":[\"2024-01-09 11:39:06\"],\"msg\":[\"2\"],\"thread_id\":[18417]}"
#> [1] "{\"time\":[\"2024-01-09 11:39:06\"],\"msg\":[\"3\"],\"thread_id\":[18420]}"
#> [1] "{\"time\":[\"2024-01-09 11:39:07\"],\"msg\":[\"4\"],\"thread_id\":[18415]}"
#> [1] "{\"time\":[\"2024-01-09 11:39:07\"],\"msg\":[\"5\"],\"thread_id\":[18423]}"
#> [1] "{\"time\":[\"2024-01-09 11:39:07\"],\"msg\":[\"6\"],\"thread_id\":[18420]}"
#> [1] "{\"time\":[\"2024-01-09 11:39:07\"],\"msg\":[\"7\"],\"thread_id\":[18417]}"
#> [1] "{\"time\":[\"2024-01-09 11:39:06\"],\"msg\":[\"8\"],\"thread_id\":[18423]}"
