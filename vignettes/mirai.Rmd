...
``` r
expr <- quote({Sys.sleep(time); rnorm(1, mean)})
...
#> abstract://07184995345f57da253728e8 1      1        1        0        0
#> abstract://59561d1da83ecd539b533f5c 2      1        1        0        0
#> abstract://75bd2a10d00ad137bb811c1c 3      1        1        0        0
#> abstract://3402918e6e57e752b765a251 4      1        1        0        0
#> abstract://756930f0de19f5cc2f6d8a75 5      1        1        0        0
#> abstract://fa5da7ae1d61af09d9d0c3e7 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://1a172738ddab0a83da4a30dd"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                          
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpqwfsBq/file2cbe81895b9\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                              
#> [5] "  ..@ flags              : int 70"                                 
#> [6] "  ..@ vfs                : chr \"\""                               
#> [7] "  ..@ ref                :<environment: 0x589b7386b3c0> "          
...
launch_remote(1:2)
#> [1]
#> Rscript -e 'mirai::daemon("tcp://hostname:32997",rs=c(10407,24754300,357762893,1378402730,-1641892061,473722376,469927017))'
#> 
#> [2]
#> Rscript -e 'mirai::daemon("tcp://hostname:44055",rs=c(10407,450427091,-223890981,1723310613,601701887,-1576096667,-104141784))'
daemons(0)
#> [1] 0
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("wss://hostname:32853/1",tls=c("-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBANXS160gnqAXSB5+HJQ0XifHo0CONyWE1SIiz5/+zs1VGItH3JQd
#> RqVLjLJon0Iosm6/1k04S3/hY6uWLzEjYlzh2JZDm49htS46XyCVfjNuR3MYMmQs
#> dzm9LOsSLPnKjHPCrvRhu/xPUyPKiECd/+E/zU46HSakQsxz0ji2zlVszI0v3l1Y
#> qshfueBOv7S+Wmqkh7u/HZey5MZ6hkJ3hufyc5/ouTtA8S1gH7uxH5dPW7sds5Ov
#> tU3mB4fJqH+y879mA9Owy7wWj+Ssubu+hi6QJ1/nWtsghn+4elxUTqy2CDkGXwZH
#> sP8jsZHXWrPK5zh3Cbkz+jEcUfgsxBUGMECwuYBRlwiaxTMDYRwsa25WY5tG1juL
#> Z0gugYmbRRPT4NwGRmRbN5XjcUGaCaEkY97Fnsn2JbdPIJ+De/oIOVWD9NhHQwqv
#> GO2m7MDVpFrY1+E9hZ5bQmcIJ0OmKjr8SpFV3VXHVxC9pFy0okwtkOb2ULE2mV8o
#> qANsJKymHfxBvd9VKDThaxf79/5BW/8H96aUO4lnnr65/ufXPYP1j/m5mt7fgYZE
#> yW1rnLFcpD7mgdTB5BEOPl4zlUtcCESrmcsV9bSdAZkm4lTZ/LE6rapYvA07ExWq
#> cq+4U48JlxWJCzMNlPbwx+KElTg6CCfbSJ0iKvW94gHHbd5SQBThZn+TAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFNqjsDzE8EW0yNRlu0Nf
#> 4LQz5cgbMB8GA1UdIwQYMBaAFNqjsDzE8EW0yNRlu0Nf4LQz5cgbMA0GCSqGSIb3
#> DQEBCwUAA4ICAQA62KdM6lbuEr9XKOgFCK3QRe3jWrAjGHkGwChB4gBv9QU/OrBE
#> SpjjqCJ6nrKF0BfEGmLdR4FOXm3E5qQb8618HTJsoBwOpK6Ns79vgt+hN89r7SLR
#> fuBopnfmx0dwS0ie9V0s3ktzCqoAlIYjR+r29XtHQyqOt+XYFKOlDWzFnDrXYUTj
#> ZbYgAyyU5uVwzHdTNvz8ysP/ZbCCQdqVeXjIAjTrOYTd1uS5jLWls0nTyEUGzfia
#> gZcP7v6KvNcNOn6iJGFIHWGIhSVUb7WXNouNM/TNATEyGVzfJvlXS+qj2x385Ycs
#> BnCRHtWIRaSe6xhC4WSJ4Teox6JdWkps0emNW1mkb61QBG2l1cysRYEdEvbuXOo1
#> gIjx1YdgUnijNFpB9pNRj7PekYLS2NefR+q/nLetVlJ8t/ZGu7oyF/DYApNwxJ3r
#> +/UFPM0Ysi+YJgel9U57FpLKqNiYDS0CBK127jd3CcZF1KAyxh4jWqdsikHZ8MGS
#> 68d5/9NWpa8bv1BNuyDuzp36d1k8dqXIqSWiG60gigSE4pO21tAzxKZ0LzpuawKQ
#> f/2LQHbXjN/XEah0waWOSe8uick07yEeFtcDnGzmWsfPOdvJCFM8aawjVIf+2Hll
#> 17W4cxaJhILghcII5HzXDx+ApmffIy+CbzCfVM30YLTYV20POpRCQx3ZNA==
#> -----END CERTIFICATE-----
#> ",""),rs=c(10407,-1257729509,-110928224,520152609,-980880018,412163863,702615660))'
```
...
```
However it is possible to register custom serialization and unserialization functions that hook into R's native serialization mechanism for reference objects ('refhooks').

`serialization()` registers these for the rest of the R session, or until cancelled or new functions are registered.
...
To change registered serialization functions, just call `serialization()` again supplying the new functions. As an example, we can switch to using [`polars`](https://pola-rs.github.io/r-polars/), a 'lightning fast' dataframe library written in Rust (requires `polars` >= 0.16.4).
