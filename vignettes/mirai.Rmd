...
```r
m$data |> str()
#>  num [1:100000000] 20.74 1.09 106.38 -0.26 -6.48 ...
```
...
call_mirai(m)$data |> str()
#>  num [1:100000000] 3.254 0.523 2.401 1.036 0.767 ...
```
...
#> abstract://6499e6c70cabc21226083e5c 1      1        1        0        0
#> abstract://dbe4ef0cc797a79b55d97ecc 2      1        1        0        0
#> abstract://0f9c6d5e29309f59aa1d79d7 3      1        1        0        0
#> abstract://1f80e404c792642f01315df5 4      1        1        0        0
#> abstract://51f7a0e43cc7d46ea27b6573 5      1        1        0        0
#> abstract://3a26f8cc70dd9490d61216a3 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://c0d8b8d22d0040fd830a4d3e"
```
...
launch_remote(1:2)
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:44977',rs=c(10407,642033924,-896234443,1346893682,-391909301,-1899611376,-1597170735))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:42295',rs=c(10407,346413147,587461580,559275723,829030531,-1633435061,-995914678))"
...
launch_remote(1)
#> [1]
#> Rscript -e "mirai::daemon('wss://hostname:45081/1',tls=c('-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAIh1mB5x2VKWZj1TCOy/hNAVkgzwZEREH1pBQw/vmzqlA1YznnXV
#> 2Loi+DIOEeA296mAnjKwYO/wjkCTGRKdg/B8g5MgDTQr3mhjwZxoNUjWWce/7CTl
#> qsgv4xxTJi9x+dbGOFYUA1LJy/r247tvUUr9rmoj9+IH3GLQhacFfEhd9Q/zD4d/
#> 5Y1O5vT34Rm4tu0+IbHfvZjQpyCAEnGXNFK15eRtQXRZyqVoX+wxeWHuWvxuVp70
#> Un7W3hvn1YdtPdXro33/weaJq3FLwESRVB2Iv70sz2D9GeekvwRIruZdf86bwb4x
#> C8cdZR7ybj6cm5mIWVn5G8nxBOX67dCALSzkvXYoionlRC+F5H/a+u5DROY2bXuf
#> MwA2KQ9AULwtS/Y4IXF/ELOU44qApjSM9TspWY6Csd7YaKFSl41L1ZvsbSD0+sX5
#> zBpdvXvKHCCpbnqrMlfDzgRyJlTV1k36gjjwsLPizMOd25LGni9ADZZzy3CfNbFh
#> cVneu5C2jqDYVkd5DQJmDFhe68F3z8hfrJW3wtXFv2yPDbgBUlDFYlrSFBnSi6SH
#> Va7ws/EVNEAU0Q/nfYyhIEwCQWKt8V3ihQLdOuCMdDepEbfkt1/HVGMLIW5dPb5U
#> ny3mBSCGucJD0YbowZ82KNSie6WMnpyJVqDQw2XnUZiJNZP1hcqlvqkjAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFGdzqa3JXCQI5W911B5H
#> j/qFfJ3PMB8GA1UdIwQYMBaAFGdzqa3JXCQI5W911B5Hj/qFfJ3PMA0GCSqGSIb3
#> DQEBCwUAA4ICAQAFQpt3EjumNgsx2Qm/9lB5OHLM4OxPqCzA2ZzLxN5hE0f1itLm
#> W8T516lbAz4wQI6zzCcBUnR7stuqcdeHW6FYk+TXrrRgyMiWGKb5PKQOhqiGX0cv
#> mwO5oaVPd9ERA0Oqw7gUR2p6m8/PBGmwTT9EPONLtsErKYClUGXbxX3FU9MxU/Bk
#> abduo+qF4V8DdRD3AmBkBn7/p+Cg3ORy3L7VLIogktSXXz4jAUrWW0jp8o2AyuMK
#> Xe2Es1Q4xOtuNHB7Nej8AJ8F46Pr/CtjIvUUwOGjnyZMVtQJFvYlKYLZE0OnLS//
#> G6asYyCjkQFwNrYhwmTooxjGSg5sBdsCWVz+m6dwcIOhWEN3cuXODjlSbT/VUc1F
#> w6GNJR8xtwWZIcv81h6j4iXKp0j4MgWfBWMFkPS32HmuLFGEwrg/2doi+hgfyguO
#> Tx4kWQqCBkLjOmmp3D3sm0jaSmst3yG0+E0o0XhGYFYI2GV2JNn2ZT/EoAeeLkef
#> StLtWCaSZWCgnK7vLC1wqKpT8WYpT2XwjWlv2f2ceyy2/KQgypoKYu2I9k1i/5Z5
#> EihPwnLXPAccdWe1Fxh50s74xIDSEcFzqxzmK2ir/HJXbo5U0iT/KgUiLUaMOKzx
#> pHTiDLTRz4ebjMvlHojABnMGBuTNoSMS7QxKKMy+++RTeYCdOyDRIdaEjw==
#> -----END CERTIFICATE-----
#> ',''),rs=c(10407,-1706828673,-687274828,-1406539739,-427964766,-1133491781,-479950400))"
```
...
If a daemon instance is sent a user interrupt, the mirai will resolve to a 'miraiInterrupt' and 'errorValue' of 1L (interrupted). `is_mirai_interrupt()` may be used to test for such interrupts.
