...
#> abstract://525eaf752ac38a51af3af106 1      1        1        0        0
#> abstract://28980ab4c0d110d25bd4b110 2      1        1        0        0
#> abstract://f10dae38dd32e509ce2b07a1 3      1        1        0        0
#> abstract://f672bd06a7a174d4750d354b 4      1        1        0        0
#> abstract://972431c3b7fdc56a40803718 5      1        1        0        0
#> abstract://7252d594206d60ebbff1c267 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://44dac6f430930629beab430e"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                          
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpoF8rfA/file396dd042ac8\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                              
#> [5] "  ..@ flags              : int 70"                                 
#> [6] "  ..@ vfs                : chr \"\""                               
#> [7] "  ..@ ref                :<environment: 0x61a5f77503b0> "          
...
launch_remote(1:2)
#> [1]
#> Rscript -e 'mirai::daemon("tcp://hostname:32825",rs=c(10407,1271856928,920054945,-1061115410,-858314345,520091884,-880127747))'
#> 
#> [2]
#> Rscript -e 'mirai::daemon("tcp://hostname:45271",rs=c(10407,-428103544,-489118397,-613263763,1634375354,391117332,1042205344))'
daemons(0)
#> [1] 0
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("wss://hostname:37867/1",tls=c("-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAK02zfLW6GtuyGjDumRLm/FhgC/fubQT0936uMUF2V2aWDokc0WB
#> mtD5CPMYtjFv5g+TYi7HSY79vJX1XWjGo/J1b2sIpCAUnLWMYX69+k1TdNrWapZ5
#> LeOVwXFLYlDXz34H+fOXyfSIoC7bisIvV0YJE7FoiAwHdzt1VJld7HL29TI59W4g
#> 4ddT1UuWYi11LFBF/Hc2FjqLgp6jnyRghP4Zai7snOnuAkhhQDgtzCKAgl3iaP2t
#> /fOdtNQ1zTisI13Txz4rxq6mWYmZe0LVUZqYpSXBW8Xjh+TdKmkBk4m5t78pY9Ii
#> vlx9NnvPOK2LRR+IfEnUmmd3UXUKAptsgUEvkNpLqikPqGf96vCxAr6A7yh0anj0
#> 1SY10/wuLoeAE9KrnfKq7DSBzVxYPv0oTEILOAPnzLldzeYVHqB4OiylAD7hBgjB
#> +Gl/IK5clcnTZkQauiKfsAlP+psiIEyX5Jj9I/bjT/RmGgyFxGErTU0Kw3dU+eQn
#> e4dtSxPLEy1GGl4bVhI6JxCGFDu8l7lhvYwaTiMcs85tORdEnNajlgBXHwYGNu1M
#> 8aFU2/gNiG135CTv73wMAgqHo2a0FrnM3PCwtkjkCkxqG4qg78L8bSfk9O1ZZ91/
#> u41mqT7c8zta/N9egNhPOzrmN6BOWOiME106erNhcYm9tTfS+ZkGXqFbAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFMrlrdW8T36RyXV9eldf
#> F24rULYKMB8GA1UdIwQYMBaAFMrlrdW8T36RyXV9eldfF24rULYKMA0GCSqGSIb3
#> DQEBCwUAA4ICAQAB+unqL3eMy0oZZBK3XP4pLfH1/oLhlJzbqTykkvmQPMgWMSD7
#> SWP2T8wgUCv0JQ8xeSzcSELRaLE3Tb4snfzP1fvHc/5wGXdMBC4h9qA/B3sF5GmE
#> 3j1r//CD+2D9uTypqpy4cOb2y7yzkDcQXTIBG94PHffhJwkdMsJLBg91kEFKkRJB
#> uKanvvhgQzPpbn08MuhkRYdvX763N0h9ktAZnPxjB84nhzaLLUuosuIQm5FylcIW
#> ATBY018pq6xoNXxf//0zq0kjPuvgCk5yJaJMwboGEcnRK3ftXV7U8nvKFN84sJqd
#> dnH6OSmjjRfobmytSoki3MC5M/36wk8opusZCoIoolfRjTEqLiSvTJnXJh/UdvHV
#> 2N4+te+6FqMLh/4FxU7+TwjLhYMgIVmB3qzD4f1QkpMmowOSPBiwLDBn65G5//Sw
#> nMdnE7tsqJOGPAfkCllmUZjM9R6PrUcb1uASjH4/G0ms3YOpRie1bEmTjZ4NVNxL
#> 82yuHJKKTCXefzeAjInQlTQ7yiU4GbOhd/JVnq/MHzEqk6KfYotE/CjNZyMZN6Sk
#> UzbkbSOmJfgWyegE+2P/t6pAM/dF3exi27EexYi4e/2IQcu8j6FXcSa0pP37KFMt
#> TLmb16xZge+5Bn7ABj9nwBgs+bvIC9yzNNr2iraBP2cA0Wm//2WkxsLweA==
#> -----END CERTIFICATE-----
#> ",""),rs=c(10407,-1781196606,-425153189,-214208288,1010090849,-1483906642,-1143271849))'
```
...
- `x[.stop]` collects the results with early stopping, which stops at the first failure and aborts all remaining queued computations (note: individual computations already in progress continue to completion, but their results are not collected).
