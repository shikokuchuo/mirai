...
``` r
m[]
#> [1] 4.586077 4.234604 4.356826 4.364007 5.743120
```
...
m[]
#> [1] 3.756358 4.149778 3.818186 4.259896 3.493573
```
...
#> abstract://f249f3b4c1840b53baf5ff5f 1      1        1        0        0
#> abstract://17eed97451c995fe592f6efa 2      1        1        0        0
#> abstract://4a68559f6344ff784333f2f5 3      1        1        0        0
#> abstract://5ee5e8534bd11cf04676074d 4      1        1        0        0
#> abstract://bf487b6775ae0824afa6f479 5      1        1        0        0
#> abstract://9539f3a0b169b35d53ace758 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://1154e204deba1f1a1e1817aa"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                           
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpqaC0f9/filea5c752d287f6\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                               
#> [5] "  ..@ flags              : int 70"                                  
#> [6] "  ..@ vfs                : chr \"\""                                
#> [7] "  ..@ ref                :<environment: 0x5d8034370680> "           
...
launch_remote(1:2)
#> [1]
#> Rscript -e 'mirai::daemon("tcp://hostname:35821",rs=c(10407,551986990,-1235274281,366020652,502908733,2002756826,399512723))'
#> 
#> [2]
#> Rscript -e 'mirai::daemon("tcp://hostname:33921",rs=c(10407,1253717521,1944212868,-1928085072,978977878,-739728227,2064830776))'
daemons(0)
#> [1] 0
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("wss://hostname:42459/1",tls=c("-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAMsMPC9WU3tPgj3fplF6B1iPY1CdvMje3uf0nrNTfgQ7VqgANGLa
#> g9t1r/eL51belTSQFYymjEC2wMyZwHZQJCU1VOluZtATdQOHsVjSGyVQdlDCvHP5
#> h1V4RLRlyHN6jkXqcLfr54wjEe1/s4yQLx0Jhb+aeC9X79DR0PehYZ6FJ+Dym1OP
#> TIw54n/raRcqyfdb5/853RLL8LcBFUx1+sgQGoKocrIMWBDoHSDV/4blxaDeAQK3
#> r4ikzwvBxKLQ/spLIKdYbOgnx+ynVrAAe4UnLU+cZJPyAtD7UJmmiDg1GeQEL0KW
#> lVKGvxo3HobRJVQevkwtdRrERHJ/DUJinSAkMcuvgMD2bftDTqeRDBLZO2eu8RLK
#> eDGCBMqxQyBdRqdgGeuuPuGP5xYYiKy4r+tA81zIWrj63pyaeIpN/bcjyIXJ+l3E
#> xvbeg5olLR1nI1ezEGKryGiWthTmJSuGewSQidXelD2QC8Ev++I5P0xBbstvJzVD
#> 3cDa2RobWvHl3lL9XOq2fZqfKbwaU+DXcpzqrMLgBzK5HbFh1ykBl5eGuWGvRptr
#> ory+zHANNVM4SpJ58tOpxJGUznfd0sTDpj8a+X6JFIhubblS+hkP/pf/GqMTRRA2
#> e1JGEh0hBqw4HzF38sk6u/vyTdNxXpCOBCXoD1YyMbm9B42P84HXxkT1AgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFD3APPmB0fWpT+GM95hC
#> XcPTfvfvMB8GA1UdIwQYMBaAFD3APPmB0fWpT+GM95hCXcPTfvfvMA0GCSqGSIb3
#> DQEBCwUAA4ICAQB5RAxLzSFEOgSKhWjRXCvaa5OkS4EqqGsBqA+HTFyRiiEpjBvW
#> 4G698gKR3g1NmCOXTEJ2rdYzkQEEV2XtWqCDfAtJY2pRIOBb5dTGW13S1wd1J494
#> LSsybp3hJWo8T/7vFfwbEhtKJW2oHdfSU9uTOUCuNjRT6/1SBzypFY40iIG8UG2G
#> 1UIRWKinX2DhBhh/lOAFwDImd4LsbKjY8E5TkLUzbaPHTtGsbXM0oSzMmn8pYNVo
#> oqtzY++O4xXCLNigen6vormMBGox9vEuELRoIXiEGbOsLLGQ/8RcwJnd3Hzh6MSN
#> 3n50aX7ShLXsdCRC2TqShBDXUu6e+0Im6K15nm3jcwv0AFB3tNUsrXdc51GkKExD
#> QU6QUTaCR0wQg9jzKxJnU7StVQfZnko9tVpDHem4uvyi7EXOQxAPPudUFzoTU1cA
#> wUtc8hrPYY3MZVc/m/FZJ/TQuOBQVMlKWoUGili3uGVF3daW7+kN9er/j6ZP6KWv
#> p1OST2SEi1IYg+m3KH4h8tRh9BoCdaLV6xqnL6VJgGIHEwKpKtvJqCPBZ6tsd+Dr
#> DRZ9wolGkXu047yufpVumJBHFo1UdmxxmI207jevLotjbUusOaMPCqxG/7zJqEo/
#> OX2x6R98cjmQLmWc+YGhzKQMkm042iGQ1p+zllPaOgvHrNlXCqOtD3q0Ig==
#> -----END CERTIFICATE-----
#> ",""),rs=c(10407,304154702,976067703,-2081466804,609613533,1832708090,2038920499))'
```
...
- Calling package functions in a mirai requires namespacing the call or equivalent i.e.
```r
 mirai(mypkg::my_func())
```

- Do not rely on the shape or contents of the `status()` daemons matrix, as this user interface is subject to change at any time. There is a developer interface `nextget()`, for querying documented values such as 'urls'. Note: only these documented values are supported interfaces, not everything that may be returned by `nextget()`.

- Testing on CRAN should respect it's 2-core usage limit. This practically means limiting tests to using one daemon, without dispatcher, to ensure only one additional process is used. Always reset daemons at the end and then allow at least a one-second sleep to ensure all background processes have exited properly. There are of course no limits for testing outside of CRAN, and a full suite of tests using more daemons options may be run locally.
