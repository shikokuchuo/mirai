...
```r
m$data |> str()
#>  num [1:100000000] 4.323 10.358 3.94 1.19 -0.245 ...
```
...
call_mirai(m)$data |> str()
#>  num [1:100000000] 0.355 -3.086 -2.255 2.292 -6.845 ...
```
...
#> abstract://5bffc643710790b1ae61fd18 1      1        1        0        0
#> abstract://52e110a38f4fc15ff902df6e 2      1        1        0        0
#> abstract://4c4dc2041e2af05516319c68 3      1        1        0        0
#> abstract://0edf034e928aae7be91c6014 4      1        1        0        0
#> abstract://e325e9b2e86f1432d3eceb47 5      1        1        0        0
#> abstract://c72fd0d703a4d40cad5a89b7 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://79722a7e8b6eb57b1392e633"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                           
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpcH8QeU/file9ab215b8d958\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                               
#> [5] "  ..@ flags              : int 70"                                  
#> [6] "  ..@ vfs                : chr \"\""                                
#> [7] "  ..@ ref                :<environment: 0x559aeaedf548> "           
...
launch_remote(1:2)
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:33175',rs=c(10407,1531731854,1552988855,873975692,-1138274531,-107228358,-1631840397))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:39753',rs=c(10407,-452354462,-2067897056,-87524742,209607135,255330569,775243726))"
...
launch_remote(1)
#> [1]
#> Rscript -e "mirai::daemon('wss://hostname:44187/1',tls=c('-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAJg8tJxCVcnZbP+rLB/YF3bVjOFG4SLpAAxpStOed/mXxPXA1Q0o
#> Oxi3jjQU4vQoJwkkYIeyXTN9Ou6avRcWr8p8ouVIw1hqHQFfBRYIFqdsOdxYMk3k
#> 4x3BUZlJdNpw9kDYdF/myVl99ngFfgfD9/pF2BKxjz8BAQwHvxmK8RTyxPKACUey
#> VZvI81SZR8RYazoUqIr62lENZ58CHKDbttI+xkMBywY+9rwlzxhnYOEi1Un0tREF
#> kXxGhkHec0vPLKU37a1q2+G9xjSA9Qd8eVgxJPp/QngiiKkPR6IuRSFaYJ3ur7RW
#> 1KVouakg5oo5Z+IrYMSOJvpg0Jngb2bxqwn+WmrXLLixCHmC9f8Lc4Fp2EQ/QCsL
#> iuPyAXzFsE9asj0mJ75DfyoueZRIoZzFHtSPwY9KALtCp++LFBOdXfqIFGSsiBAm
#> 1c55QdLYn+hSzGR5G9QlQGJ1PRm4uy7q5+J5rxQw2yGeYXxb9sLyBpOIUdocSdMB
#> LYe9dbp1NZxeZGJxa5NjfxVtLxkIXv1JqnoV+LFM5jdbXmGFLti+V4HLz9un/ARv
#> 9n63qQjgZZsN1qHIiBG0ldNyonZDLE2AyhipV2G09E1HDKWnM4sA378z2c6eCZlk
#> ZprXzx80zVkzXA38UsdBCUnJLV2nBC0Jb3WlScmu2s8JtbaW44iY1vTpAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFGTtDe0xRUW762gKBB4B
#> lpwgqJCtMB8GA1UdIwQYMBaAFGTtDe0xRUW762gKBB4BlpwgqJCtMA0GCSqGSIb3
#> DQEBCwUAA4ICAQAZxoWxlwIfeFnpThPG9OqI0l8ax++WCQdTjHLNYysUrDaUWUZ9
#> 5H1/png3Wi/K+fvGznH02f6LCfTImW/TSbn/jK05V5+1Rp3f01U7EYpXj6IO7Hqd
#> LtmoeJzcLzfmI+Br6l0q7B9ixV+hqpmDI0+RdzkZD+4YAaQC6erAtNnaiZ4j/tnE
#> JsjZfcbOaPKiMPtI+VNsp0C0CBgbdDcBq1v67KOAHWpVh74vlA5tmCj1/zg1VIiu
#> PXvYl3kYP9hKyfK619m8txApNbeepsiNYSnGDicxGLpR8x4PdKfgptT5ner1owpS
#> XOPLgnlKtx4P5fZApu4Cndv4Uv3HqRTkI6GSMbkO9QCVtpMO1+zda8dRMsFYC3Yj
#> 3NBe7uQWvfe+zKZj1cIxlP80hjfIRdfcrstJOVB6sFVSJef8GVfwvVszhdG0Tri+
#> lgfIXN7gXw/M+x8utGIl2tJrsuaTU8DxAbNz60YDxjKdnC1PYmohuRMMCub7CV0z
#> rS4Lc8Z858qUQmPCYuFauaoOjglLcgRwxDLjE4ln2QX6Tknq+kQlL1ChH5MHsqxU
#> w3GkTGIZj06EHqy2wWkMSbLBu6fmLteU0RC4a1bqfpuDEKrcBd6/rv8+rBUPAHT2
#> HCaqpAWcwsMaEHyNAxHXskF7XZSlG5ijk89JbCCe2bl+Zg9DIKjIDC/fVQ==
#> -----END CERTIFICATE-----
#> ',''),rs=c(10407,-1811929382,-1393414509,-119553352,1791640921,249040198,-386584817))"
```
...
`mmap()` is a function analogous to `purrr:map()`, that uses mirai to perform parallel/distributed map.

It includes the same '.progress' argument to optionally show a simple text progress indicator.

Whilst it borrows from the tried-and-tested interface of `purrr:map()`, it also includes the '.args' argument from `mirai()`, which allows conveniently supplying a list of arguments.

The function itself is synchronous and will wait until all results are returned, and is user-interruptible. It also fields the following advantages over other implementations such as `parallel::parLapply()`:
...
2. Alternatively, implements early-stopping, which stops as soon as an error is encountered, rather than continuing to perform the entire operation.
...
#> 
#> [[3]]
#> [1] 21.45494 19.60198 20.93156
```
`mmap()` assumes that `daemons()` has previously been set. If not, the operation will warn and then proceed using one ephemeral daemon.
