...
``` r
m$data |> str()
#>  num [1:100000000] 0.363 -1.306 1.99 1.451 1.75 ...
```
...
call_mirai(m)$data |> str()
#>  num [1:100000000] 0.221 -2.007 8.106 -1.403 0.736 ...
```
...
#> abstract://eddf00a9328e8fa9c3346e5f 1      1        1        0        0
#> abstract://9164b8401acc7f8c855cbef3 2      1        1        0        0
#> abstract://08a039555fec5ea5a152db50 3      1        1        0        0
#> abstract://dbb72d54ea8ccfdc3d7e0116 4      1        1        0        0
#> abstract://538e060400a631c00ce4230e 5      1        1        0        0
#> abstract://1c083a26b4aeeda6f548dd9a 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://2e786c22f69304a00667e07e"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                          
#> [3] "  ..@ dbname             : chr \"/tmp/Rtmp3arFfs/file146386e42fc\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                              
#> [5] "  ..@ flags              : int 70"                                 
#> [6] "  ..@ vfs                : chr \"\""                               
#> [7] "  ..@ ref                :<environment: 0x5ed12be3f190> "          
...
launch_remote(1:2)
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:40447',rs=c(10407,-1820241688,9540041,1791095542,1234963711,-341943500,329559205))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:44635',rs=c(10407,-796500264,1510210235,1046631417,1461005486,1266210815,-1546749699))"
```
...
launch_remote(1)
#> [1]
#> Rscript -e "mirai::daemon('wss://hostname:35911/1',tls=c('-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAM++XTYIVxFK2EcAqC3k96o6l1Gcr9lya3q5WsM4MIWWhm83peVz
#> H+jaW3u/V+Unggfj1ophL70cTJndN9YG8nrP5NJ5PV8lm2kgHKCUReHzTpPlnInm
#> 18FCVzyqqn5IMwDFgeh/S/6/D/cVRFAw4SPLbXjo7uR27VjVZXWB4tiYvXp/xBwE
#> 5HBJe11w6HPKBhNEYBZ7EK1sbVfe1XWblQjJXM4tFcOKLiv4vuakdTvF72bblHx/
#> 1J0pm5PtxEXxWngGEBftF8crorlmphtHVMMc0lVyQRCeWDDSWBk4xDCZNlXMCaVZ
#> S7eiujIBLJKO7Y0X0yozf7C3ljGwvKi2kafeRGyZ4rR5v3lqJoOZA7BZ3EACJruw
#> afPUpc3ddFRw67/vyjM7pcTpAh3UnwJ5TavcbOQ0sH9ZuUnrWZqFkhN/dED0udQ0
#> ga90jhr+np5vZ48lia3+jrJ4MmUFUjJeQrUKQfGpjKRH+blVi+URCDwQwY5a6rQ2
#> 9bvQrvcfLKTlgXiexkGKATBWE5PrZMwWI5OCAgCY2qXQ50cjLgio7SLG7tOnHULB
#> 4a2yzZg8PZK7nFCitHIgOMEEuPfvjZ41Qx7YXHqQMFiT4yNehM/LaiQnWzzKcm+D
#> +OhfHD3Io3Dy/mp0V1MoP5kW2USWFqNcXRWNm6ELWacWG3M8x3E89OtlAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFJudS1j1+vg1xWnYgttE
#> 54HrxbvnMB8GA1UdIwQYMBaAFJudS1j1+vg1xWnYgttE54HrxbvnMA0GCSqGSIb3
#> DQEBCwUAA4ICAQBVNzNi2R7q5YbN2XD7YsPlU6rVYDw+cwhSfx+biqIw7/mIFV2A
#> Y/n8m2/cShxlLtJCWy2jBwc6YOzVFKyRw9ZgHq4LWWw2YGTAAJ3kplN7uCl/8cuU
#> MafY/xfIl7O+5+i9wP0yuK4gVU8EaFNQtRsTA1JIkhp6GyHut4CEugq/tNjVbco9
#> 1jHUABBEqrOIxhuuxiKfTbUEy9kr5pcWmI6SzleCIL3oIWVhrQgtSEw9iQmdMUe3
#> ysmXrcItOmi+dhb4p7UoTRSYYid7u6hIvlZZz/l4sdoWJ8rttLf1hClNIkRGPU3R
#> raA6KhESH1L3Gur8FsWd91DeTemX23jAfdd8qyGkGcYufqaLVEcSpyXaxAzhMPVU
#> XMuW+zF5HNF8BAL72oDD1sd9yKiKLkgXoaCzat4TyJSfg9t4IrF28j2OCbOg/3qg
#> AF0acZgfupDyftWTaHC+csILo1xlClIvtX95EGFbyoyC2R3UUx48PPPZDLQL9lcq
#> LRUjlpw8+93b4WrMlkfAL12RJY8CgK4sANCcF2DEQ25aCV/AFVttmNTI/iS+OCiE
#> YV4W2/7WzvXDQ5LD1ZVwsBJhX26rZ42thsXtajNjiiJo+SbdcdE0e6bh7agoE8Xz
#> WBVxcLHFCsoNCsxQe1g/tLGjBlNIreyFLBBmVYaQ2MAx7zFdmWw3QvmGjQ==
#> -----END CERTIFICATE-----
#> ',''),rs=c(10407,320333030,1705507375,-379143516,-647902891,-740521454,1689221739))"
```
...
- Does not rely on a 'chunking' algorithm that attempts to split work into batches according to the number of available daemons, as implemented for example in the `parallel` package. Chunking cannot take into account varying or unpredictable compute times over the indices. It can be optimal to rely on `mirai` for scheduling instead.
...
#> Warning in mirai_map(c(a = 1, b = 2, c = 3), function(x) do(x, as.logical(x%%2)), : requires daemons to be set - setting
#> one local daemon
```
