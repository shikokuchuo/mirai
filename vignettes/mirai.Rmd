...
``` r
m$data |> str()
#>  num [1:100000000] 1.1938 0.0135 -1.3936 1.691 -1.1258 ...
```
...
call_mirai(m)$data |> str()
#>  num [1:100000000] -1.252 -0.574 -3.652 0.279 0.685 ...
```
...
#> abstract://b558381385eaaae8cbf41460 1      1        1        0        0
#> abstract://e0dea3fd25c5531b61518fb1 2      1        1        0        0
#> abstract://18a453b4a5c5718394c1833e 3      1        1        0        0
#> abstract://077e36ad4f84b81e8e20fa06 4      1        1        0        0
#> abstract://76d1416b0304c278d0917158 5      1        1        0        0
#> abstract://d2d25c102eda04112e2b4076 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://bdacc4a01e0e5dcb81420354"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                            
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpBa9kBP/file12f4e37d0e9de\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                                
#> [5] "  ..@ flags              : int 70"                                   
#> [6] "  ..@ vfs                : chr \"\""                                 
#> [7] "  ..@ ref                :<environment: 0x58a86caa0e78> "            
...
launch_remote(1:2)
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:35397',rs=c(10407,-1731110000,1557963345,859641822,973103815,-635816868,805345709))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:44525',rs=c(10407,-853399387,1198069353,-23195162,952552579,752034090,1936310355))"
```
...
launch_remote(1)
#> [1]
#> Rscript -e "mirai::daemon('wss://hostname:38469/1',tls=c('-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAKotNe/1ouQVTnwryXi8Mf8ru6VppGiZPYNZDazM9a/q1l+boWuT
#> toz124/g3np0pcDzUOMVnusCbUivfBGQANcej33VEBLVJGk4VLYE6oJcAxKQp61o
#> z8pd8Xvs4hrHQZyGXaZ1YtorW+zULDcbRRbiwaeERx3QcM7d6/WKyiLIbrN0Eso2
#> Jw+/99v3KkWZKSVcQADUGefn7EFLLi/Tqmt/P/Wf72s0DEaRUryXFoYJDceGwL4x
#> POY+E7phDBvnSni+JYmAP3/bR34e+H+SRAoZq1IXRcvU5KskuIiVEVCozIIiXOcD
#> gP1WFW3ny7v31XoCg8eZ1HqhC1O8vKMKecxkTlCmlEmokUmoEral1CIYOuxxICUr
#> mg0Y+lQUcc+bK6TyCAI41laTGfJK3LGuZSDKrwdUQ4U0FmBeBhuAqpOp8oI3y/Fx
#> irbX36KAZUsZ+xp70V0rLt/f7nnx1qTDleJzyuYH491FxMYmuxTwB9BBvbgIuBij
#> 9CIzBXHH35l0B1qJ0aUryePDFUP0FCjQ3nYfw29HaXRp/XrtsYYi05Ko6rMXf6Np
#> VSHAhAE50p2HVWGSlAAOxA4yDuDi+wq3drUFTbBkRYDOnJmCOcDYsFR+/tWPa8xY
#> +PpuT6N7dTy/f2gAVnEnXeUnmSPZ5qD7K7fEPi5Abjvz7nxuD7Fk/S3LAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFD/VpGVInVM1vH4IE+e+
#> Jh6juoDkMB8GA1UdIwQYMBaAFD/VpGVInVM1vH4IE+e+Jh6juoDkMA0GCSqGSIb3
#> DQEBCwUAA4ICAQAnTu4MBdcOMeNHjd6E3yr5ku9TeKzCZn8d3mCe/it0RaJk0hpa
#> E/lVCr0+tPPzLWvSFQF0njbTlQD54QpA5fEiRmYPBsakfHHAFea+tyhW8B7opvN0
#> GUYx6DI+m+0FbcQjqz8UHXXqz4hIrkGcTz6aBlxja9RZ++utv66MwJNry2bovaU4
#> NscdNlYawWyx36JZDmK3uygaFJ4lv7eNc4vn9OGhFcSnnodPCFXuMAqjNDNTApV6
#> vQxI67dUMqMxW2IObfzO8LyzFT3Lu8v2b0IqGv847e86r5+6NRzh1aIeL3GqXJhr
#> k3KVYGe74iM7ntbkQCJ4F+AqM+CqadkSpEp87QtBHue/7AeKXwTzm9vxUrQJ7V+D
#> dcS8f36v2rsNR7NUrUR6izWiml24vadEfPszlriqOejnYA+ZlbZbktggg5cAvBoV
#> YUOLFleKhNWyGJzh9XX4Y9fEynKmPbwqoI4kXuONbtSDkfTM4F7OB1Ku/jeC1OrX
#> iWMpwB+1oZtQ4b76YmgT4ACwTcLM2JC8yg6u0rtlVPSQs5sIA/+tSUMuCFSRFH7l
#> EV/2IIGa0lCu1q9a0nmfTr5FhhzPf2WlnQ7qox3zRXZDQ13TbqNK0haUGEuMn7Fd
#> i3Q2btYoiU/fyy5+jVCKyIbQ4fENelWF7Fd2X4YL/a9Vyl4GMFN+w1a8KQ==
#> -----END CERTIFICATE-----
#> ',''),rs=c(10407,-44179215,-1987420674,-2003752345,-439537796,-1607183795,1147195562))"
```
...
`mirai` implements asynchronous parallel/distributed map functions.

`mmap()` (mirai map) is analogous to `purrr:map()`, but returns a list of 'mirai' objects.

Combine with `mcollect()` to use their return values.

For `mmap()`:

- Includes the '.args' argument from `mirai()`, which allows conveniently supplying a list of constant arguments.
...
- Does not rely on a 'chunking' algorithm that attempts to split work into batches according to the number of available daemons, as implemented for example in the `parallel` package. Chunking cannot take into account varying or unpredictable compute times over the indices, and any saving in communications overhead is not as great for a package such as `mirai` where this is already low.

For `mcollect()`:
- Includes a 'progress' argument to optionally show a simple text progress indicator.
- Option to apply early-stopping, which stops as soon as an error is encountered, rather than continuing to perform the entire operation.
...
#> 
#> [[3]]
#> [1] 18.65746 20.31501 19.30212
```

``` r

ml <- mmap(c(a = 1, b = 2, c = 3), rnorm, mean = 20, .args = list(sd = 2))
ml
#> $a
#> < mirai | $data >
#> 
...
#> 
#> $c
#> [1] 19.30056 22.54108 21.09120
```
Use of `mmap()` assumes that `daemons()` have previously been set. Please be aware that if not, each computation will be run in a newly-created ephemeral daemon.
