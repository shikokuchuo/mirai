...
#> abstract://0cde27b4728e4e4a272f6f52 1      1        1        1        0
#> abstract://924f6be802fa09f567bc9f6a 2      1        1        1        0
#> abstract://898b15accaa5b5aaee15d118 3      1        1        1        0
#> abstract://ff3b614340fd485b11b6f663 4      1        1        1        0
#> abstract://476f00e5795c4a83a9e967b8 5      1        1        1        0
#> abstract://d07d9a69aec5bf4f522d91b1 6      1        1        1        0
```
...
#> 
#> $daemons
#> [1] "abstract://5ec62422a558c10b60b03e77"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                            
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpH26Cou/file33b125c121569\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                                
#> [5] "  ..@ flags              : int 70"                                   
#> [6] "  ..@ vfs                : chr \"\""                                 
#> [7] "  ..@ ref                :<environment: 0x5d8d749c34e0> "            
...
#> $daemons
#>                     i online instance assigned complete
#> tcp://localhost:5555 1      0        0        0        0
#> tcp://localhost:5556 2      0        0        0        0
#> tcp://localhost:5557 3      0        0        0        0
#> tcp://localhost:5558 4      0        0        0        0
```
...
launch_remote(1:2)
#> [1]
#> Rscript -e 'mirai::daemon("tcp://localhost:35059",rs=c(10407,-1116512779,-283333070,-1660811253,-585891888,215050641,1335813662))'
#> 
#> [2]
#> Rscript -e 'mirai::daemon("tcp://localhost:39469",rs=c(10407,-1908094354,-2103090684,1476772182,-577084218,2139903305,464260722))'
daemons(0)
#> [1] 0
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("wss://localhost:41885/1",tls=c("-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAOOKQlj7p6wib4qJQzi8gBqETxWbRmvhjRbkCTPddOYy5x1ic2ui
#> ZamuUaPFWgUi8vpxIJ2GxQANJmlYauY7LRoWE//8BZjjNCeSnFZvpHjhjBxFHK+P
#> AwE6XUyGymgJAgiQ+aJXCTDGA64jLKL8NLMynWNP3Tre7Ke9Wdz4I+Xo1HOhRjSj
#> a5rZgo1+4Ko6M+qfRlZH9tQD7B3kdIvYz77T+y1Im/rmwx6E7j0i8u9kwNgYZjiD
#> 9T3SEO2XDKpi+WetntIg4lB62cLz7hbphGOPNnl5I8fo+wb089TjAZQ7Y+mbShhQ
#> 40EZRXxbs4JESjxGHp0jfYNgWZoTguwcSO7yQLpV42ZTG/yJ/2uxenbMIwp3/zuw
#> yTq0oveEke/dvaaeyLQyZGQCe1+z7vcwHbs2qYWqZPK+uYT+AzPxKdGG6J05/jVq
#> uQqvMrdctKbGqjjKQPrlJZ4q6OIJ6yP6GvnAMtIFxEnD+D9capD9k9pTnV4vdamF
#> y/DKXHLEpCAd9/4ewIkSll/AvoSf8ex67jPaQsiA9IiSeLsH/oSvUbzSlZzjsZWi
#> DxZi73bYGKIlJA1y5n+ALVhIJb+/hGXQjRltGuGs8EaF3UoenEYTMqOB0ggLanOJ
#> DMdt076RrdZJAjYgDQpJW9M5mlhC8qP6kIUh2M+NxCVrPYBBiIuYpRtNAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFNKBHidFXswAHUmfMlX6
#> SWx4VJeTMB8GA1UdIwQYMBaAFNKBHidFXswAHUmfMlX6SWx4VJeTMA0GCSqGSIb3
#> DQEBCwUAA4ICAQCNWM3//TSL4lpWaiXdce/ZNCDyaVS+tbQIBCO+7MII1vc8kMeG
#> pCsRiTMcjrrfjiz+elj3VLbNy4bUo9Zsm8EgAP2JhyGjRKTtW0cyZiDgBxZJLBqJ
#> oZHN9BomoKecBSLVj98mn04XA6BfYfit06JSU9Nm7S2m1xub6CI1R2EOzMwWiqsX
#> fPQe/8yH5OABu37P3WoRtf2wUUARwOZbj4BM8l5hqktgD6+nfjYe/joMYPESe8IW
#> OyB8uCMr/eta44yAt+XYzLTUKlPJH//AM/N515KaVOmjTsmoAHl3b/YrNP88p3E8
#> XX4fuhjhZC9eBMmS/3Fxg5OPmPFABvxoeHaoqwIw8YqElmD+FBJkqbDBV6Pwswb7
#> WVRARHSLQtEO/r7goBIA5a7dYozjgOnFs72hQDFBlezTd2QZxLzer9h1E3E+GjOF
#> ljoj76xlnHOgAkTvh9khrGcRdv6XSn8CnIt7xGvs7sY3DA13t4Jg8kv6C11fOh2M
#> HUDEBiBwphUVvjqMrRTktmYxTq8sZk2McadgUK8Qto5XJyQUZtV5IIpKvJilqNjU
#> QdLGBpxtM+QhLoofUk0OCRX6Pa1YDaS0WtJhQiAbyqnhlJGsEcXLg1SqZdoL5p2x
#> VzwbgeeDw1eJ384gd+UBzfNRcfih0Y1gQEAi7Q/4tsm2+0s7WCfzQbVvYA==
#> -----END CERTIFICATE-----
#> ",""),rs=c(10407,-804932997,-1860490368,-1082698367,-1217919666,736048503,-1393829044))'
```
