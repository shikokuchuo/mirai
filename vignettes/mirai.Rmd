...
``` r
m$data |> str()
#>  num [1:100000000] -0.67 5.127 4.347 0.216 0.267 ...
```
...
call_mirai(m)$data |> str()
#>  num [1:100000000] 0.167 -2.785 0.591 4.022 -0.291 ...
```
...
#> abstract://6d18224e82c2089ac6ed7e43 1      1        1        0        0
#> abstract://102d76a703c8acc9798cde6c 2      1        1        0        0
#> abstract://d70f268de2c7c0694e7841b9 3      1        1        0        0
#> abstract://bcfe4016a2870afebf7c5fb3 4      1        1        0        0
#> abstract://41a1725d62980d878d8cb853 5      1        1        0        0
#> abstract://5d643a3f7d67b91faf84912e 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://3a96339b0fbc7109b691acde"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                           
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpdekhKN/file61347e0e28d2\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                               
#> [5] "  ..@ flags              : int 70"                                  
#> [6] "  ..@ vfs                : chr \"\""                                
#> [7] "  ..@ ref                :<environment: 0x63fb24fe6d58> "           
...
launch_remote(1:2)
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:41997',rs=c(10407,957846585,2124519078,850530543,-1268600220,679210517,-1536575534))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:43401',rs=c(10407,1674303749,-492646836,164795359,1845027286,240206104,859292186))"
```
...
launch_remote(1)
#> [1]
#> Rscript -e "mirai::daemon('wss://hostname:41653/1',tls=c('-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAK3OkhWvXX7e+dvTKDgdUbYqJQ2Wzn/NvxaOuy2RZLsTwOPqzDl/
#> Pt8Sr6pVs7bGyrkcL1woPU4OVBpSumifer6aQ5KUCRusChbBhCwztuk2yBost4XX
#> wxHgGFD0YbQ17qJETWmmj5qptOgwEGl1/8ZC0jXkGZNf21oVi8iwPj9Tr12lsQR0
#> 04pCmwWOSrDhGt3WXzuFHBaLX7GysYhsy6issQhJrKFbnJaZU0IQQ7HzHm6V+F6D
#> bkmziLe33c8Q7Np9JrmZKPp4TqLg9FjdcqOvKNpwtpQz5XVkVspL1cnDQZQHae0o
#> cJXaO4IpOLvKpN7OWuaaARYeHBUXG25BXIHyuMbOQslLsg29BeREtEI0RTWAKBmS
#> +iJZbPdhoiAg9AqkG0hLfU60XmAIuRdxb/urt6K2kBlDcIA7CQWLomjdPHeRzv5/
#> IKVMLA8JMAxg+OwLDCjEwNLLxpkRncog8TdnkxUBH4+DFC/vbNvkBbvUvGUytjFp
#> CZTgLVEnvpuiZJ9D6k7pruv1Wdp00Q0ZhDUQbf51olcL+o3/4IxyjW0Z392dOFZX
#> 1mcihtxDrXJSRa519azMgk4Op8VUrzR1fml9W/1OX5BnsrNO+z4ziqvj8Ibx8KZP
#> IAWgIOW45GQtZEMyHh3897jKjx8zBIU3AfL2TyNT7Lzm0Ye/JzCCBxybAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFAO2RJwuhcHpt6vYxHvA
#> 1shq7CyZMB8GA1UdIwQYMBaAFAO2RJwuhcHpt6vYxHvA1shq7CyZMA0GCSqGSIb3
#> DQEBCwUAA4ICAQBf79aFQAjvMQH0bxOUuLPC3uLh4B6X4LSGV8ACfThjyaV/AEf6
#> 0Dvm32RyOYV5ToHe+6wPZZQ8tlWLEfM7GSJf3MpHzVGrRWDtTYsUaswDT/eyYi/s
#> mhOdYeW3A9eWiLuFDc0nz0h6gWfKrU6y4+MUTtPuwFwNIG50kO/gYCPVoFMAok8R
#> /EgPKevfbilStrmw+onN/iT+htuzpZllwY6ru1Dmjq6u3r0n/afNrOmubtND0aEP
#> Y6DNZwhcIDaud9w6rWVt7u909Y6WBtWhWvU0QSSYy3pQrN+8xo4JUrkHhssm7/7S
#> YjLIds2aTN/4/cL2p8b9JGmj71qpCT8jjxnOzFlkOq/LYNe++Wu3cH5yYhQoA44f
#> emx4YuBPbOc4UENFRKNKhTf8HqLg3L1M57pghk/vuLPnj3cDRBjfc1PUfldgApx+
#> oC76YIsDVgM8YYdtnq67FgV5BfLs3sXBYx76sJ1LozcdtwGdC2zVaJy5VOtjxsVP
#> sjj3+a8ll95F03+CCDLcRLjOEnRuRj4oMI2ILjEMaLn5KFaEjzCG+2FW/HXyQgWy
#> zF3XL4C8ZP/T/o0s3miRO2ah6B0zo5yqTO9eo8cSok8it/IlejyTn/6xI49oUcDo
#> WWpLqm83ogQ7zrwsgStGIBLITtP5s6uQT10OLp5tC1xWNgBeufoPPddKlQ==
#> -----END CERTIFICATE-----
#> ',''),rs=c(10407,-446972972,248720581,-987374910,-1506932901,1888912096,1342975329))"
```
...
`mirai_walk()` is analogous to `purrr::walk()`, although completely asynchronous and returning a list of 'mirai' objects. `mdata()` can then be used to return their values.
...
- Does not apply chunking (processing multiple elements in batches). For lengthy computations, or those with varying or unpredictable compute times over the indices, relying on `mirai` scheduling can be optimal.
