...
``` r
m[]
#> [1] 3.558208 5.743425 4.888773 3.785005 3.338659
```
...
m[]
#> [1] 4.906920 5.271571 4.218875 6.651503 4.003625
```
...
#> 
#> $daemons
#> [1] "abstract://1e91c958d2a49eb05ae64122"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "abstract://e90603425cc03d296b798813"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                           
#> [3] "  ..@ dbname             : chr \"/tmp/Rtmpo5mjpE/file41cb41194d77\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                               
#> [5] "  ..@ flags              : int 70"                                  
#> [6] "  ..@ vfs                : chr \"\""                                
#> [7] "  ..@ ref                :<environment: 0x6304ed6282d0> "           
...
In this case, specify the 'url' for the `daemons()` call to be '127.0.0.1'. This is as the tunnel is created between `127.0.0.1:tunnel` on each machine. If 'tunnel' is specified as '5555', the host listens to its `127.0.0.1:5555` and the remotes each dial into `127.0.0.1:5555` on their own respective machines.
...
launch_remote(2)
#> [1]
#> Rscript -e 'mirai::daemon("tcp://hostname:41371",dispatcher=TRUE,rs=c(10407,437957399,-175074196,-1866705283,-843932902,1694533075,1846141176))'
#> 
#> [2]
#> Rscript -e 'mirai::daemon("tcp://hostname:41371",dispatcher=TRUE,rs=c(10407,1435381127,-862551695,1967361084,-1020101871,1019659094,-1664533767))'
daemons(0)
#> [1] 0
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://hostname:40391",dispatcher=TRUE,tls=c("-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBALJQPIVVgIALCB/2uCpM9nN6q1GrvkkyHmF3ifWDV7Ojz+PYb8fE
#> Sls5Da/rcSzVDEyv4e8MNEZ2c+1w42t2E54kKA3v7IOBqaRrMxsXruJAMMYBonSr
#> rET4JddxlE5mwyMbLaHPMamdJvgX+zG53RCuSJc53KBetjw2nN9dHoFUYPjQHSWs
#> JRs/hy+ZizZv9XwN77NkYghnFEmHdS+NOxEWFdvOfO8h/7lgiz1uW9VaMQ4CPMSz
#> zKvd60W38s9unlh6bXXPr8ChoxDH45rfeow7kfFlqpy7ah7C7hbhPkHphbYBHKr0
#> iH/vgz0jQ71q2K6dgs/0bIVKaa+Xe4yQ7ZV+9HlZYoBLq7Dy5TYQXR5zZZhnxWHC
#> L0iwXfSw4uY29ksqIhcLdkrPWDh7rGzpGqco8q0dbUHePSP5eIcc0EBlUsScSp1e
#> 3RodeV2Uckywocekkmx6tr36gfQjoWZ9sdNRmuQ0tw3mQ4FSBCIIItsgAEf9sHDO
#> bQdg6ps8D0vI4Etx+AtL2TKYmFItwBtdIB7BDQDOdPmTl1Q9aShLkOM5GrTcJ8Qd
#> asTcUDbUhweKwb1qhqm5TLmpUnRO5v8kSLyLnJ0aZHhUiIinnWj1fyvt4fOGB+b3
#> hToRDaxjsFD6fB7PfqEPw5mGoN6qOHQYiE1QtsBdun5fArQk317XuIzVAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFBWDSq/BGh2G9BxX9Z61
#> 63ikfBSKMB8GA1UdIwQYMBaAFBWDSq/BGh2G9BxX9Z6163ikfBSKMA0GCSqGSIb3
#> DQEBCwUAA4ICAQCrtTzw8dooWpnVY3bu32Vwysi3Uop4nDeOBKcjphKeZWhAv1v1
#> /UXCwhzpo8lob4W7GwZApSOM6Z2KQGz0VMYOzcPEObYIrRcLSXM2czWS0O6oLP41
#> 12ZuMbQ3im+2QXBzpEr9ocy6e3QhJ+GOKrhs7yEeXWhaschnguxhtcOYWigB8oSk
#> E8txsLdr/TZFNlN/HjNfI06a8v9kb+xiDqFDx4dMQuv+urSe/7qMo9wKNNKLLjKD
#> D+KQsWhuIqAt7QIq8heOAmuhj0yMFkw9yjXb1Tjd8k3yYMr2ouaXXqwZExjZmFh/
#> Avf0cNrusl1VOCxJ04hnhuEPogoLonjqH+q9f4Xc5cec0u1a/6nZuoN/P6EGIXYy
#> x853njmY2gWi+Zj+Cq3LUGCA97z4mQjuNHKKGeJbiHdDAvNtNkV8Pv2IU+FBiOH3
#> JMoGif4Q0UZag2NeK/6omsgksTN3SFrcvaP3u2nGxMjIUyQKzbBc3Bebzshwrgtn
#> xhO1scE7DYE106fnkzX3iUIPzqfg5V+St+SSQ0Jb1ZjiH2vZ7VulUa/0bv8MjxM1
#> Eg+xnYPmhjBIWb6KJEntD1bdw1HdNWwq9Hkq29ZeYuQ0FdLC5TjKCC1Mnokg6Rvx
#> CcJMMZvf/+GNLXrvliDHGL5l6ZMZS89QgUcAIU9l3GvhZohsuA8Pw7WBZg==
#> -----END CERTIFICATE-----
#> ",""),rs=c(10407,1575578979,2078121800,282539177,-1632976810,2060870367,-1550745708))'
```
