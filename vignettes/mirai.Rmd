...
```r
m$data |> str()
#>  num [1:100000000] 0.29 -0.142 -0.122 -0.687 -6.082 ...
```
...
call_mirai(m)$data |> str()
#>  num [1:100000000] -0.649 17.049 3.474 0.88 -0.609 ...
```
...
#> abstract://ab8fc9b65e906e7fa44ee851 1      1        1        0        0
#> abstract://62b967eff9a16a72812f4469 2      1        1        0        0
#> abstract://2ccd4cff8d86ac894aafce2c 3      1        1        0        0
#> abstract://3344ed2b7c781ee7b1cd050f 4      1        1        0        0
#> abstract://9539e7ee2605cf1cb095fe79 5      1        1        0        0
#> abstract://21687820858c2feef4d205c7 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://eb732d8211e6d1412b2a191c"
```
...
launch_remote(1:2)
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:38445',rs=c(10407,-627784904,1514286041,-821026362,-1016587889,-583550332,-1264775243))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:43525',rs=c(10407,985152587,-1744492267,-1583351969,1744297918,-1451584477,-820560744))"
...
launch_remote(1)
#> [1]
#> Rscript -e "mirai::daemon('wss://hostname:34383/1',tls=c('-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBALrr/PEUMvnw4ywdsnAUWv6F5HgHFoVPMPSGCxngoQ8/ALnOJklz
#> SAu6gSibUKpUcUSKJ1qml/nTv4bwA92jMn9dJEHengPV+0PCY8CCGv267BQ2qPng
#> FexcTi6xOYqdkeCl9Whuj2h8rPX3N+mhxSh7Qjo88fLIIWj3eE8ptdD049uUF7TP
#> WXC5FJRFVlLEyPPkwjrGvagvfD6nbrWGfBXeSolC1Y41KG/EV0a7Ad4ZuzRgQT8E
#> VIPcjYs4jipQvZDWl7UGh583FTuStq1EuQKm9dnORRx2DBpGBoS5mk2P/wkrayv2
#> Lf2f6q4nFF3wQ7PDCsEOpf+O/Fy8YTuQrv2UfI8YWuL5dC789EB+NkcI+jzrB6ar
#> fIq8yB0y3Y3KHmlf+7yBT5ugQctTvUWepbZ/iaNlJbXLHzWEAKKQrVLM4Os+z++4
#> fJFYYkZMTrFL4U1TNRhVOEiC3tnT/89r1JTfk0/4GgpEmJFXaRq49oc16Szm6Q3Y
#> xXzq7KM3y9auHsAj5f/OmkqZJWIwYJZDevvm2N+6vhAXIxYAmP9UmVoKp0YaWknG
#> M0axfH8SStJHQOvK/8WNFlV0fH7Jj91BJ7aDEfPMtd6/28j3bnp0DSbRcPaoxnYg
#> IA2BOTvYACzUJgPi2h18Xtmx34MqSOsAWOTQN0oBYB4uVVJv8FoB4ZMdAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFKvlwC7xW+ZJ9G8dvK5Q
#> DkZVLH5/MB8GA1UdIwQYMBaAFKvlwC7xW+ZJ9G8dvK5QDkZVLH5/MA0GCSqGSIb3
#> DQEBCwUAA4ICAQAGSOFrtfScToYC589fkpjgcq8/5lCRwCCH91hBE0lxOI8FS+v7
#> wt2NcI5CuYN6CZpWbtkOxyMrVP52AdItY3Ai0SIgobRGKHZCTXz/1TjT4o5G2gqe
#> KvJGwT+fNTrLSACYl7bf5MVGrdwHIVyZXL13vOARAluJi8wVUY3N4W38rBjEtvl0
#> Cg2b5Yc9Ch4Ad+QzX4ZGDG92wY6F6YE7Oft4aHUrp7wQki/fiN8zvbpz6nqQr5cV
#> uJg0uUepXkD/2LmhRToqsQB+KTsWtLahyKrc7epZ1/Zv9ev/dtaRtG8g9KjoUJ1M
#> Fkffa0PJrfU98FrxvdSoT6kQY7g99jfxRPD2JZUA6ggcJbFNFlmQmJKT0vqiqz7Z
#> Xt/29Wihw2eThY/6KhsKBTPeWknSVNGCvFLmiTUlXe9/YYC3FHeYxOJxwScJKLXu
#> sAYv8oRhFrEKZx6jAHmkYzMLPBbMwI4pSio+hsLjHG6B+QyGy35MRJkhOCke49HX
#> 77tpQwXhuRcK04fbZ5FjN/GFMbkVnBc0AJ0tjE4SJpWrZclCh3yvnNnEtaZ0KSjg
#> fLznrqavyP/+gbwaGLq/EsPWKqX59wZorR2HDHQMGS5eo6DQcRqamln3izvg7/Zf
#> 9e+R1R8P260iDCxzDYLhfda8kHPTL8zWIlIuZg7NW6JUilsB1nZIPBwQ+A==
#> -----END CERTIFICATE-----
#> ',''),rs=c(10407,1271246410,1701860163,1114641320,-127449719,1858315190,1169184447))"
```
...
The below example uses tensors from the [`torch`](https://cran.r-project.org/package=torch) package.
...
Next we create an object containing tensors in the current session, and send it to the daemon for computation, receiving back an object containing tensors.
...
The implementation has been designed for efficiency, minimising data copies where possible.
...
#> 
#> [[2]]
#> [1] 0.5918690 0.8152065
#> 
#> [[3]]
#> [1] -0.6816973 -0.6108433 -0.3468641
#> 
#> [[4]]
#> [1] -0.2636026 -0.3811464  1.2477853 -0.2947447
#> 
#> [[5]]
#> [1]  2.94512140  0.97409409  0.00154193  0.50387762 -0.28791868
...
#> 
#> $daemons
#> [1] "abstract://287a350bf8cfd94ac6af4ea7"
...
#> 
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:39905',rs=c(10407,-164014304,1819763873,1347994094,-1696964201,2037108972,-2049029891))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:39905',rs=c(10407,-1526891247,1121992225,-901299957,490685206,-2078607357,-1843336580))"
