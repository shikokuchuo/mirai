...
#> abstract://06c56d2614b9d25a8b7df8e6 1      1        1        0        0
#> abstract://e2ed098307b6cab71932332f 2      1        1        0        0
#> abstract://80ed62ddda4728b483344466 3      1        1        0        0
#> abstract://b4a4e579576c1d949dd13b17 4      1        1        0        0
#> abstract://cb02866128e0b74628447e8c 5      1        1        0        0
#> abstract://89ac21aadf9e2ecb327ecf4d 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://e96062a7f3386bce5da77dc7"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                           
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpPxjmNk/file8ce56f4bb69b\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                               
#> [5] "  ..@ flags              : int 70"                                  
#> [6] "  ..@ vfs                : chr \"\""                                
#> [7] "  ..@ ref                :<environment: 0x61fb280bd2e0> "           
...
launch_remote(1:2)
#> [1]
#> Rscript -e 'mirai::daemon("tcp://hostname:39355",rs=c(10407,775630316,883212797,1204170906,-1161380525,1712706168,-1381916135))'
#> 
#> [2]
#> Rscript -e 'mirai::daemon("tcp://hostname:41085",rs=c(10407,-1098278341,529198479,1737598058,-707188318,-1141273301,2034305860))'
daemons(0)
#> [1] 0
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("wss://hostname:39237/1",tls=c("-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAMx5+QU9FmQpeoIZZd4OfoGaEacDJgXX88B7Bo1b23aIUMTCgf+H
#> feN0DkFOGyF2viDRRdBXZI8fWniE8Q+tjlSgneeHJwtaGT8LF00B+/Nso/0kajd9
#> iWoqJPNzrk09Z/DxHo1e54hFcYiXzXeM8RWA8JHtqFy0uq0fiYd0wEhHfOZH6Hy6
#> mDdvx4kMVixFQcIRzh/2gjPAv2Wf82adPFuoH8N7SaESLGtPzpKjP7mQ+dhDr6OH
#> qr+zy3Z+EngKOx1sLu1/sonsWqOflFeArf5VUB/rFolWjjVJoBLTKmEYsDa95fKt
#> aew4h1fBtfXg6PWuO7I43OfQPcCd27/2RRuM7v1D6qZ5ACjm2TE9BUip9MGG/OgP
#> efqlKgOrQNkAIjFkrPKKh+11QZ9IYdYa3P4LALSa7zzilQWx4uOmrJZJo5XYNP0I
#> OZcCpmnaX4wCbdSIA/OtWkKt7aOW6spUjEcnE6HhJFSf7LZUT2d//aSEyTW3xObt
#> 4GbCIiD8UbQ1bXrLQnmAy1qphtOm8Chk3tA8t/6h4nK3Rov4ff138qYbggjsyFzq
#> kxu2vrewLiWYgB8KB0eynSZPi4/4cuTZjE7Nc4A4MKiM0ObzZ/cp7437DvPHow7d
#> VsziKagW9SvYSxMkMtqA0bAjKOaTX+okUeIhVVP1vD487LkovfUcaAwHAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFGC5gFnwPrHz/buTOMZ1
#> B33AZP8XMB8GA1UdIwQYMBaAFGC5gFnwPrHz/buTOMZ1B33AZP8XMA0GCSqGSIb3
#> DQEBCwUAA4ICAQCNgRC1HAlPf4YteLdWSeSbi+MdE+7hc6tudTYSs8N1dqqplMSX
#> Dpzt9GdYuuz5JL6WVsUFr3Do2fAUrLKlr1aQet0LJNhOfOJVy+umL+H15jU0B+k2
#> iuUtICY9rKyQZqqsT9UOKtpcq4uVqPWxCYNPfjJnkqXqZbvnKOwSyy3xYUnGntyi
#> jUGBFtNG2aN6b+YdCWP6+pJ2I/Npmh0mBHfFcJ8ZHFrX4QJvaKr6mhdiBSrcAWQW
#> 28r8vMERg/Gf4ev31E2poUL5lmqfgLz1NvU0udQdDaWa6+eS8kjAxRCxoPJA100N
#> p+W340/kL/0kbc/07TfR8htzxDwmheRY2l3pWmsDPikAsKOrAQ2qRCQqr4bBmAf5
#> 5pRjvXKXXeoVxFBwKqdDEW2QLjEXeSFf9EQfD815lqG3mINyDxQXRzMkRBgfRL7B
#> O1GkZPAkbK4GSPeYwnk4F9uVTIG2APtP2P38YKmC4rP9YebjLWhh2lqUOVJ/oz8j
#> rGlYxCu5QVqX3ugGVgJE0QvYY742W4+AUg6SUL0nYYI9YIpZDsg97AdyYeau1smp
#> +DSSTTAsS7PA9rsRE4NMicYEuhGRvLIvUxvQzQ6j3L5ubfTph9d6VboDJtP9WXe9
#> z1d7kmryFNdlaSmxgrb/Q7gac6Yu/CaZ2dMSSrBdebJSIo5XkKZMsqfHfg==
#> -----END CERTIFICATE-----
#> ",""),rs=c(10407,-369226096,1438579025,1441252062,1381650887,-633235620,-1299062611))'
```
...
`mirai_map()` performs asynchronous parallel/distributed map using `mirai`. This function is analogous to `purrr::map()`, but returns a 'mirai_map' object.
...
`mirai_map2()` is a variant that allows mapping over 2 lists/vectors simultaneously, similar to `purrr::map2()`.
...
``` r
tryCatch(
  mirai_map2(list(a = 1, b = "a", c = 3), 3:1, sum)[.stop],
  error = identity
)
