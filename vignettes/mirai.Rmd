...
#> abstract://d24ef23714cae5ace0c6c7e0 1      1        1        0        0
#> abstract://71e3882f524ce51129a042e9 2      1        1        0        0
#> abstract://b7e32fec37e3e3f4ed6e7539 3      1        1        0        0
#> abstract://87ab4aef880144fef5d4d15d 4      1        1        0        0
#> abstract://c8eb0fdf60a6f8a0ad53bd00 5      1        1        0        0
#> abstract://a7d70a1a3af67790e815e78c 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://25704a95c1879896604d8831"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                          
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpGQnQj5/file4bf5e6e8877\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                              
#> [5] "  ..@ flags              : int 70"                                 
#> [6] "  ..@ vfs                : chr \"\""                               
#> [7] "  ..@ ref                :<environment: 0x5c413634c9a8> "          
...
launch_remote(1:2)
#> [1]
#> Rscript -e 'mirai::daemon("tcp://hostname:38483",rs=c(10407,260729409,-478321906,-327284681,-812753140,-824067939,-641872198))'
#> 
#> [2]
#> Rscript -e 'mirai::daemon("tcp://hostname:36081",rs=c(10407,1854703976,1664757015,-1383778438,719019596,-141368545,-174397331))'
daemons(0)
#> [1] 0
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("wss://hostname:43809/1",tls=c("-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBALaocn6xfPoHcB7XT5D4PZWigsjhu4UiRTNKZh0tXldiv0WfAjVV
#> lea2D0+7OWyrB6LhVqac+Ke/5s4lUHQWMfqUt8Q03FPKvspQ4ZgZSmbWZHSuaVnm
#> jaw/PLcNPSPOVBFuhi+cp4K+3vBDe9Tv5UIgRWeNbRdBKZQ767nr+Zps+0OkgSzz
#> 6RcYN3v+svt41kdSCmH835h2iU7w+936d78+Z6t6mg7446/VNmLaMRgeO4xjsS/T
#> 1qAA4c5mFlGoJJdcRFfZE6XZVIMK/cR3KLiIK/xCnatRrzEgA5mVPkrJ4M8FtyfB
#> HsfYLZ4/wD3g1kbQU4T+Jx3JdF5mPEsbzElZe1cu2lSH9TzAGEkHWEZ6zO/ftBUn
#> 9wzs0Pksy7T0gQURgUqxf9DnYplZxYJ2E9EoOnjpUDNO/NsQmwVpGdIWNVSQVqO4
#> XKCmlC5WpDqpV5Ky/GZc/UDhFXGy8lb88zpRHHECNxJYZjpTuYnsiZfZuhNg6WiK
#> R8YD2ObfLdx8gQ5MbiGqffmhPLvIzQ2pFvX4QduUMmuNJHtMYG2an3/Ai2Tzw0rm
#> VsCWzXaOZ0r/X4Tal3F1JTzQ4AcUX46UHJqXV6q6YxZoL6p1mxJ+pFJVVpQuzL55
#> 7SVM0g+VxLQp9j8VndFpYhg3FvZm1aTRhERhHK8hAaT9n0TE4SwwMxMdAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFK5FLlonZt3vMNQ51pcm
#> aNqAM7pmMB8GA1UdIwQYMBaAFK5FLlonZt3vMNQ51pcmaNqAM7pmMA0GCSqGSIb3
#> DQEBCwUAA4ICAQArnokzqnUAtaIh4//B8Z4mSwlNXmgooR7/CCIdg4laLfWPKMBr
#> Klc8Qny9liPlSNycWlbONF99QRuzmodybCgUNjaMS6VtPLKAhiT8wf9Id3Y7qd7X
#> G2zb9qUy6TkvhtBtj6kr4hdU9uKrNZKGfcjrXqMPUn3vSBfiPmDF0V3rhFr5+bKf
#> ansQwQNoAFHu2UDYobSnhFrNacG3RceU/ZQti7zzbs1PfNNlqaZZtGPK6jkcNn3h
#> E4DLdAqX6VOIMHl4iwUrbvPXdLhhpK2GDJ3yIuHplR5Lubkuxil4XFKVax1BHeVj
#> 5QxJfThxDl5Y7ld+DzTtJe9iGitbQIZhYXGrfSt045PU1yM0u2Xw0jFwiWmg++K1
#> 19O8qZ93TyHtzFvimZj/VKmjJswaZ+B0mQckONDx5JzPfS4ANd+UPqF/E06eWpaN
#> 744riSsRw4/ICDqXbYawdqD89anAVKpnIEOj0UrYuvOX0YguSjDwtnUk2I9BejYH
#> F4m38Q0j26qg1Ml6OZHh9eDiCtnkmy4idZ8cmWH3Fdg2WLfLf9zREieCOEFkgO7K
#> ysfIiuvAF/Ynicpcen2n4h/IbEHEg1/Tn1CW5p6NvYYn8VPr3xxkU/pcGJrgBpuL
#> LAu6vqGP2IdpcBwQ4dyZZa4vZkImuf0TEVc8Aa71rdmHDHqjeFOshNrjwA==
#> -----END CERTIFICATE-----
#> ",""),rs=c(10407,-575784507,-1757920318,927013979,-1443933216,-1882682783,-587285330))'
```
...
This function is similar to `purrr::map()`, but returns a 'mirai_map' object. It is also more advanced as it allows multiple map over nested lists/vectors - for example mapping over the rows of a dataframe.
