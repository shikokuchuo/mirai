...
``` r
m$data |> str()
#>  num [1:100000000] 0.081 1.263 -1.203 5.546 -0.896 ...
```
...
call_mirai(m)$data |> str()
#>  num [1:100000000] -1.674 1.386 1.052 1.578 0.558 ...
```
...
#> abstract://d47a27e1e1bc3adc8659dc57 1      1        1        0        0
#> abstract://c624d9ec46693cce4794e1ff 2      1        1        0        0
#> abstract://e6b5ceaffd3554bf99d7576f 3      1        1        0        0
#> abstract://547f5fb5b00a94f642f673d6 4      1        1        0        0
#> abstract://556079a99b9ec7b226846925 5      1        1        0        0
#> abstract://63c1b418fd2b2a08c46a5d94 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://4343856df211bd2a079ea2fd"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                           
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpFtfEY8/file297f3fa6fdce\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                               
#> [5] "  ..@ flags              : int 70"                                  
#> [6] "  ..@ vfs                : chr \"\""                                
#> [7] "  ..@ ref                :<environment: 0x596e9a748260> "           
...
launch_remote(1:2)
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:42129',rs=c(10407,2126336383,1815918004,2005640485,2002460578,1412796091,-1243755840))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:45507',rs=c(10407,906290518,-1217970310,-1310738177,-1203213979,363015267,1715599196))"
```
...
launch_remote(1)
#> [1]
#> Rscript -e "mirai::daemon('wss://hostname:37275/1',tls=c('-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAJFY7X9VsAIls/aRSChuqbu7I1Cbzraexj4YiL70L/DDg3cIyDnz
#> XnsO3nsT7GvShqnBtaCs1bhY6J+X6NhQ70dGMJ2D3/zXyeAkGdQdpJDzbB9SYbXr
#> cPvOolkTWpRmGcuqnii/rbhGdrvaVBYbT7xLbXG+dcsCFwRtF4YbZ9OGzBylIjnW
#> XRE566VDvjbsHpGaiU5BWOueLPeyAjb2c0xNxRIpSCEbhd5ZpS6DWa5kBsrcQeln
#> rp81rM3tEAkqVPhRv5ybQ4RldiuFopi7YFFYNrlkq5le9LyTbFHW0u4kHApmG210
#> t8OvVZLEZIaziZFJpTnj5K2FK/98dStgAkkbEIqZ5vodO9fCqPzdkjyh/OsJWEo+
#> SLuCRwgo4Bhz1jT4yzYc96UwL6OAeZ8vqrCLZAbW+f93yuAvDbKHbITsD23RRXTN
#> keKsLhi//HUgYrGlhw4Uq02TbJFI3XbFFRpoY5qmsclyukqbtUHq7A6+K4zP+Djp
#> 81x7sxODlgXlYEav5Im2hWeTMYCgb3LDQw0mpLj4b8Yc8Vgwdx+ceG/ztM/vgvIp
#> pkkXKt37ntNOK66rEIMt3EPyorGAFSiZEZouX9morGm/jEkFA/nmobr0EN079FHD
#> HXoj9MAh4gJVFkk3fQQ+fntmrxF+DZ2O4HTzd5IBzXlYTUZXo0D/y6FFAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFEvKupJiGfTQo1+APG+P
#> Z1PjPPdvMB8GA1UdIwQYMBaAFEvKupJiGfTQo1+APG+PZ1PjPPdvMA0GCSqGSIb3
#> DQEBCwUAA4ICAQAN5A4vYuKi7bt5CcO7uvmYMUVyPWU1TgS38EwMxchvE/gz9lsj
#> QhsAaruGDi8uyZ9R2fwsKWaVB1Z8g5Yr7ZL7KGgdV/hF9dp6xaJDHw+qpDvTMoZg
#> mGm/uWmcvfPRNVVe5eBhcoKfNlf6WBoHI9JdSVpshQZh+e7Lq5KtIzzuMlA3EPdh
#> ghDmMFv7+C8WAnCYiCtxAt9K7fxDc5DfoEzabFHFHrAr2DV2hjKnwiUuo3d2MGhr
#> d+6ZQG93yZSNalr+WIRLTlu3TXPorjm29Sd5/Iijqh4CdzKfO/G93QowCerVWQaN
#> d8Jlrw7Fb99xgu1wlWvTMDLJqYf1xxGO/t9NScd+fFTmzwCr4FaaJ2ApdsMWcmdr
#> qgb6jcsRTOGtEaO6Qlx2ARFDK4s/pUKAbIIglvJRbn8aWF6w/nyaJtfVFHydhmT5
#> Pjo659ry41ZbzXQe1zarugkK5BkactcoH5w+9jiYeKO9BirrFZA66iZxDN5D0fHZ
#> svrb5ELM342x6AHLdtnJaGMqdX0oOrcb85sS8nZ8JynxhUTgcNgrucobvtQnuIPW
#> fY5M//ftl5H3uwLqDKowvXU6T6vXSqKehX/CiAHWA6O7IggWT9JAXOAQWXeSknnn
#> M5PgviEIc8hT231uMzu6a55tQUz5RrlNithGUT9oVyVDR1aJyI52+nmYPg==
#> -----END CERTIFICATE-----
#> ',''),rs=c(10407,533485985,819065582,-1268539753,560638444,-688452099,-1115091814))"
```
...
Analogous to `purrr:map()`, but returning a 'mirai_map' object. The return values may be collected using `x[]` for a mirai_map 'x'. This waits for all asynchronous operations to complete if still in progress.
...
#> 
#> [[3]]
#> [1] 20.72277 21.62736 20.04136
```

``` r

ml <- mirai_map(c(a = 1, b = 2, c = 3), rnorm, mean = 20, .args = list(sd = 2))
ml
#> < mirai map >
#>  - items: 3
```
...
#> 
#> $c
#> [1] 23.93890 20.88089 17.31171
```
Use of `mirai_map()` assumes that `daemons()` have previously been set. Please be aware that if not, each computation will be run in a newly-created ephemeral daemon.
