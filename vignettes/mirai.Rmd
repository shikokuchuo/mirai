...
``` r
m[]
#> [1] 3.620728 4.063495 4.600625 3.243640 3.445724
```
...
m[]
#> [1] 4.291472 4.392908 4.563019 3.042574 3.346552
```
...
#> abstract://12820db2be46358f2f63928c 1      1        1        0        0
#> abstract://45d4114a4a8bbc3f70cb323b 2      1        1        0        0
#> abstract://fc4a2372fc8fbb81197cf2e4 3      1        1        0        0
#> abstract://85adcf3e76f9ea50e4fa6f5b 4      1        1        0        0
#> abstract://63f1794c31d5ffafc9b3f14d 5      1        1        0        0
#> abstract://02b0cb57c47ca9cae8f3cfbb 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://fa1974bf55089f90b1ddb294"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                            
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpqcPLDE/file2939e3cadb0d2\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                                
#> [5] "  ..@ flags              : int 70"                                   
#> [6] "  ..@ vfs                : chr \"\""                                 
#> [7] "  ..@ ref                :<environment: 0x57c0640dae48> "            
...
#> $daemons
#>                     i online instance assigned complete
#> tcp://kumamoto:5555 1      0        0        0        0
#> tcp://kumamoto:5556 2      0        0        0        0
#> tcp://kumamoto:5557 3      0        0        0        0
#> tcp://kumamoto:5558 4      0        0        0        0
```
...
launch_remote(1:2)
#> [1]
#> Rscript -e 'mirai::daemon("tcp://kumamoto:37119",rs=c(10407,-45860433,-2143349724,-89328427,2042879890,1405514219,-1684199376))'
#> 
#> [2]
#> Rscript -e 'mirai::daemon("tcp://kumamoto:46707",rs=c(10407,354657564,1721438042,1455494017,433623209,-880674843,1583457090))'
daemons(0)
#> [1] 0
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("wss://kumamoto:36033/1",tls=c("-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBANNmuRVrZsAfTROM/YrNDdPfa8i5BZ659onyvVRp7WFCNGLQuWVF
#> znUMiXVo0A+FM+RZcc43ySYsk3UoDh15LKnv8WmprES+rff4Q4X7T4V5M+AoxrcC
#> ACYNEidbd5Rmm4ArmGDbd7nY0KuIb9rYw9BKSQT2o5s3+yuPCEbXphBTyvfJUO1G
#> X/RmO8KX4wVwfTDMRMYlvRMYNlfDNfs7yk+iRuwFqAVPVUsabRuP6Bj4Y233PsWC
#> zqLWpsd6yiqImw821tSOAKtuw2NrnAGQvBhN2+hhUzi232krjCmMB7bPmEbJHSoW
#> GobRPHyP5tHtLL1Smth4alhLy/nrsuI8pR0Q38ruCp+s+vvJMBhaw35gLoYhJU07
#> 14bCsa1dDWfgSTLP53s47yOUWhcl1XSgBCtc7rK1QXQ2pn49PSTnHDuydd4PrV07
#> KIQZxB0hbmhnP7uZhViVcBLPvoiPV8gyizlqqsW4v8hw7i+d3YPB4G5/9Yd4H88K
#> WSrbmHMSIx4X3bN3RSzQjc74ADtEMozuCEqIrjXo+q0S9bU1I48y4KGo51d7eA03
#> SC4E82W1VfoiH86gW39Ru/mviXQFldLUGHzPwMuJnfz4O59WmagJRGoRl4kQCzDX
#> aqqrukPH23K8genxicgIu+LftsJBB6k8zh1aVm9SZnOdNDX+b2/LHoR7AgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFJ4726Ts24HvVenBLaI6
#> UBH+MTdzMB8GA1UdIwQYMBaAFJ4726Ts24HvVenBLaI6UBH+MTdzMA0GCSqGSIb3
#> DQEBCwUAA4ICAQBi+C/Vs7YTpMY9G5YbmFb4ScMA5+4/fVl9QrZRysRNKhKx+QO5
#> 5di3KqcscXUKK1CVAZQh/Y/tuDVexb6woUm3UPAjcqSQOmAi6ALri6njIYYr71hL
#> 3UbWoO+0wC0iaEjc4QpI6qKWtg5PRALttd3v6a2ve8nNsaAZQJWCad7bGn3VZNlo
#> rHxskoDAkkRGRRqjziOIQvWbgP5YnsCaYIsy/rp2MVx6ckrJudAb4MmeiH43GoU2
#> eD+sdP4xcRz7ljBWHIXIDcgvQ3JFWF6KkZJ/LmZHWE6UakeVv5k0sCZSDyxLduJ3
#> jNcxb2iqOu3GX+P8iy87d6veAStv0U4M4q1egxgvUEjLulS1Q5VfIsv6O23F73bA
#> SQBwC/jwC4qyZGzKrXzy/STOOYxcscDpANXC7+w2pfo2Z82lujTJMoqCbiYi/8Xz
#> uuYhSJwJJhIZaicXpfrsdz2GNiAAlfyjzqBZciEwKR2dE7j42ZPVdpBa9v2Uaky4
#> e3pmCSIzV80VCiV+U7x2HZAvZZ7MQrfPahYEKE/b1JQJFlPdOfFwHMv/tqp8u97y
#> 4xtsN8bnO0jxqnF2zvRs9+GAcu+WK/Yp5Q6akVoGzdgQmW4AGwZF77RoZqWcujzu
#> AFwSo6ogApkjgLNDTkIoN1e3JkBnY6NZ74dx63gourJ6ZzxitfQ/aMiKMA==
#> -----END CERTIFICATE-----
#> ",""),rs=c(10407,591342795,-1683477104,1569508433,-596592162,-107799353,1879778908))'
```
...
- `x[.progress2]` is an alternative that uses `cli` progress bars, where available, showing completion percentage and ETA.
