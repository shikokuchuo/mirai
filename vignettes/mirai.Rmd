...
```r
m$data |> str()
#>  num [1:100000000] 2.7428 0.943 -0.0417 -0.6715 1.4403 ...
```
...
call_mirai(m)$data |> str()
#>  num [1:100000000] -114.747 0.428 -2.465 1.546 -0.383 ...
```
...
#> abstract://3801b11d5640586dff833f4b 1      1        1        0        0
#> abstract://f4189fd87629d314511289b5 2      1        1        0        0
#> abstract://e67c8ff76c7afc12fbba73a7 3      1        1        0        0
#> abstract://e2b110b7595aefcbe4145f13 4      1        1        0        0
#> abstract://9b464295becf60cf78a15671 5      1        1        0        0
#> abstract://fd25be34e567468049e5e5f6 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://0dfd668bce5f8876f4adbb81"
```
...
launch_remote(1:2)
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:42107',rs=c(10407,1249078568,-400461559,109967670,1854819903,271375220,377790437))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:43149',rs=c(10407,-236550489,1301140834,882354519,-341641556,-698933004,-780704194))"
...
launch_remote(1)
#> [1]
#> Rscript -e "mirai::daemon('wss://hostname:33321/1',tls=c('-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBALBaL3wHSzwU5dsruN1swrHKLEB/JSXIdrSQsGfCnoW90gkLvLkc
#> 2Y8XThXkFhIrFOn2tVtBDdnHER5bBQSEC11gTbw7xqeFQZt9tfXP4oYpQL7fv9vp
#> gURoNgB/S5BWIzly/gnv3UehLqtENGDpBADPXSKFq7Xd6ucCmMl+8ZnvpyHiLexY
#> UBVElD5JS3bq0sM6HbikCQaogmyGy7KTz2Zs+qJwxQ6ncv2J/hrWpfBB9FZC3jBw
#> vxJttpbBv2lgFT78dDZ+nOZmJgS0qDDso2NSzmYDcKZU53jrIBdDKCiHbKqKjOPF
#> 2rPO1x36jI0Epy3dw0QbYg87ZfgBH3uXt1jhNh55paCb7oVDvxW+v8V6kGFcZVRl
#> 4QyGtf5iRd/23ngKgykK7mhXwdlY6xiJ7G7uLb8ahjnuFOurzqMOxbw1qWrADvBX
#> YwuFPsKMx5sUoPg0/IxSHiquptAo28++ZEt6YsLrfB3t9iQ5C4ylYzTpVAgnQfOT
#> L5wn7zbbMJNCd9MLK7BwRC42aKzcW9C6pXchNbV01c8XhwDzRUoeMTo3XBTTcT0v
#> bDyMV4/bXrS4k4wCe6sPwGVhnoI7VqnpbcKl0WpItxUYzqOmgmfjWLCasLex8Yds
#> 4SWeIJYXHZVZyP9VFWrR1SXjyWP1iyAPDd3u0iVgo1KtUMymTY2lkU4PAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFAp+PH6hqzz4TRJvsPXp
#> NCDRxouQMB8GA1UdIwQYMBaAFAp+PH6hqzz4TRJvsPXpNCDRxouQMA0GCSqGSIb3
#> DQEBCwUAA4ICAQA2qsxmJc6lb/QY0pWZLODGNoiI2YIgc9lbef9RYKCyL4eOIw+D
#> aZJ/IB83J+Hm45txBOZicKe94dXG8ZBoRimPlMMZJrg5vhe+hvvjMvP5UjzKriKb
#> CJ6RsfxBUe2qH2vYqoZSwEpXZm15IxdyOTCIndUWPh6muuOGhw5/YvtRWwFlhUyY
#> qRUMQHAamI+jq99PPyy4WMw8MgsveLX/QDGnCdbyxivCMptWpslk/Qs4bNjRyjid
#> Ol3g+/BAW7zwIqB40AbHiEEZ0CpHWp2qaB3qRDJNJBEepfaJNPDTSrR9qewOT0Hv
#> xgeretXYGg/l8LqjOj8lH3eq4/cnBUTFmukdcRTD78BtpjD89W8LH0vuS6//V4W9
#> CHApHB83V4uStLCXozCOVDWR34VBAncb2WyF2Gxkko2UrUMYNwlbA9ywm6tEAjnw
#> fBQ40D3htUUxy5dNPEmcozlhJ9qy2gOe8J1931y5RJOxSXjWo9JTB7FUi6/xi8CJ
#> h0kCKuMfjuQUezDkd2Z6AF/UanJCQpqwRC7htCshaRXNFaBYR2dYTr2BJ1omx24s
#> kU54p0+RTHSUJBamd5rdW/XySK0QxXuPq1UGCk3N/ifliWyG7ne9X5RHW3cfY8zy
#> HoCzl+8zZxxQYq+Z9En/5jbfKccZ4wYisbCWeWetcCQ3XZCDu8a3E6XUvg==
#> -----END CERTIFICATE-----
#> ',''),rs=c(10407,573057208,-1930300583,443835206,2072251663,-1435027452,-950792395))"
```
...
#> 
#> [[2]]
#> [1] -0.06743055 -1.75300589
#> 
#> [[3]]
#> [1] -0.50129034 -0.40684179 -0.08198533
#> 
#> [[4]]
#> [1] -0.37214157 -0.07777054 -0.03009696 -0.43829108
#> 
#> [[5]]
#> [1] -0.9894663  0.1440814 -0.4290097  0.7582410 -0.7521705
...
#> 
#> $daemons
#> [1] "abstract://5efa38147606d6babe0cec23"
...
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:41147',rs=c(10407,-1359074414,894520811,553342000,-2135369103,1368369534,1159995367))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:41147',rs=c(10407,2137854323,258090971,-1087396749,-1221072510,1172563244,-184571164))"
