...
#> abstract://41e324f8134046563da915d3 1      1        1        0        0
#> abstract://dceb35c1e38dd31fe8d52fbe 2      1        1        0        0
#> abstract://896eadf156055e072f8921cf 3      1        1        0        0
#> abstract://4e196dcf04ec82e265494383 4      1        1        0        0
#> abstract://925025f8cd20b2ad46e0c61e 5      1        1        0        0
#> abstract://714a2d2f73eb316f982db32d 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://2cbec57f4e641c3e9924932c"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                           
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpIfaLGy/filec49f7dc7d887\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                               
#> [5] "  ..@ flags              : int 70"                                  
#> [6] "  ..@ vfs                : chr \"\""                                
#> [7] "  ..@ ref                :<environment: 0x614bcc1a3468> "           
...
launch_remote(1:2)
#> [1]
#> Rscript -e "mirai::daemon('tcp://hostname:41251',rs=c(10407,-1614741740,-1181464827,1784487938,120896411,777787936,-415986783))"
#> 
#> [2]
#> Rscript -e "mirai::daemon('tcp://hostname:34349',rs=c(10407,-645337572,-1925233161,680192934,-595235498,1984128922,246139364))"
...
launch_remote(1)
#> [1]
#> Rscript -e "mirai::daemon('wss://hostname:34557/1',tls=c('-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBALfkdy40zghSj+R/9I+/XAV61r1NV+6SUdM0+C1s09OIY9hr1XeX
#> FoKOGV779dZ0LpHM9TnQMq81wX6Gxf3CyOy3Aw11fBCXMkcUM6EUZovDQnb7IeG8
#> ZDTgxQpnnNViPtV4/6hP+zXAT6i/0e4cpGtANvNqw1QS640m+eKr9abggT/5r/Ao
#> 4+ZLV58rcf7nmv00x2YJEAlLSFbTumcBZ0fdU8ujscIpmbBoRQLKNsJMH43KNp/J
#> I6B/emn7XrUupTXi/Qagtbrh7TT45eeQOwk8IYHARF4lXTEwMJ88ZmjgOepC/ynK
#> 9Sjf2ofj9MLhmbC1bsCbz/5Wq/9xKKT0jaj40QN5e1tFcTqpXs5dG2Z4uJghGMRQ
#> L9psh82YyFgZGpgkHJNaPp/vlWFuuTznli7hW7/P324uNPztbXtsNiHoLBT/U0c2
#> V2ACvZo1Ol0+mfwz+i9LIOwU3lE09w1AG0MFbzNw4P2UhgbqiGClZVam6/BkIoAH
#> /FAvO7pS8dS9oz0pz2Zoel9T1daRgA9/7UDyaDiNK7q8Iloyoz2rhomBBiSc1YLR
#> A6xF6YFXkcz+O8Z6E5Gj7Qxupw90s43V3DTxEb/dzW3nD0nl5gxrt3Zhirj5rx1Y
#> YC3W7KvMfZhKZzJcVJdv9cx7pxaU+XK+StMToja0gXLHWXzLoc4oLBtrAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFMip5xwEA+dkU34FuTlV
#> ymwNHwQ4MB8GA1UdIwQYMBaAFMip5xwEA+dkU34FuTlVymwNHwQ4MA0GCSqGSIb3
#> DQEBCwUAA4ICAQCRvssX4Bxe69+2TnKY3azqerL/1i3y5F+ZTYnra9QO6gNdZogp
#> y/viQmNns3WzKj/ECuEdmJzKJb8urag2P6KV8hYnsePcRPxbb3HDkpFqCe70dvPf
#> TSj6gQCtO48A/eQk6PXz6evVG3oM+qIbahTp/yefODLXhSTuDM3huWiJ7WnCyT6o
#> kIB2LeumDlTe942+5/qDdXUd4Kn7ft3wQ/g6vnvhVwmwBzRk0ETQ68DQUUsM57Lc
#> MpKqQAXms4qnYE/84awXrXDe5nEm2pd7ufFgGt/vrehmcLOiA7k9P9Shfh0ZNxf5
#> cuJ5WKUpGnPEZPa0xd7+qSVJ75mCHwgQ9ggnElZTzQnT85GmDsBslBpQeqVOotk/
#> beG+9LL5RSp4Ykfm84Uq4JQDgQdeHvekYykxIEqtCOgNN3zi1XkwEg3iE9hV+k5T
#> ZwYkmIsSh05utAHHKLTPupVbA93euj4heVyTUq2qlEMyl9BBqJ/N2x9aQ+p/a8+J
#> GlthpmcWs4w2lCD2j1B8RiNwXEONrzUExO4NzJh9PVb11a6LWaeOzTchApMPjxki
#> A5QFX1b24CE4RT0RM2cd2PFwaTIQtQLKABuMSSy/zt4jRCHh7TunJNf0MzH+Qpsy
#> hie/lpP2yeaWWcqJTT4Cbz/oosEL5mG4XBBVFJfcBcQ2ukii/7PHnqgbjQ==
#> -----END CERTIFICATE-----
#> ',''),rs=c(10407,1937796841,1919133078,1321875231,-1814448428,712256453,285543874))"
```
