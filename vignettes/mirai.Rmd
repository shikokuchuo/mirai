...
``` r
m[]
#> [1] 2.680219 4.756610 2.887941 5.411004 5.071045
```
...
m[]
#> [1] 4.138162 3.041805 2.651815 4.168465 3.422566
```
...
#> abstract://c700e8e455c194aaa368d9ab 1      1        1        0        0
#> abstract://8e574b453c61dcabeb6ff1b8 2      1        1        0        0
#> abstract://631dbcefa2a1035af6b69d0c 3      1        1        0        0
#> abstract://8e2244a29ea117c8ae203a22 4      1        1        0        0
#> abstract://948c1ea8b3f051538d0de5b4 5      1        1        0        0
#> abstract://ccfa7e70b5525c674eed3e68 6      1        1        0        0
```
...
#> 
#> $daemons
#> [1] "abstract://0b0d527c1b332ee5cd5323cb"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                            
#> [3] "  ..@ dbname             : chr \"/tmp/Rtmp0hOwqa/file27f094b82067b\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                                
#> [5] "  ..@ flags              : int 70"                                   
#> [6] "  ..@ vfs                : chr \"\""                                 
#> [7] "  ..@ ref                :<environment: 0x59840fa8ebb0> "            
...
launch_remote(1:2)
#> [1]
#> Rscript -e 'mirai::daemon("tcp://hostname:34489",rs=c(10407,1310063767,-1576669204,-69460995,-122994022,371205971,-2129546120))'
#> 
#> [2]
#> Rscript -e 'mirai::daemon("tcp://hostname:40709",rs=c(10407,-1580297822,-989256394,-525146036,-226183254,-55335039,1511625224))'
daemons(0)
#> [1] 0
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("wss://hostname:37173/1",tls=c("-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAJcVcvBoOihlKMFRKBfSTwUETv+/w3Ebdz2sVOsy0MEYeNiWGHQ3
#> mgW67FMYQ/yNmEYWSLwuXYRVB+xBgJBR0+mANIlsswYjAZXfcI0mCRhI5rWrZ5gX
#> D+UDCHJrBB2ZDnYphgm/gDbCBQEVmhD2lwmdBx1tstgY2bm7U89Np5cgDAFyL/zt
#> 9Suo7bYyl8qnuWqI6YV4+FAoPOmoeasDknv5S9D4pgurEiLY6K4QNlUFn9Nr8KbK
#> k85c/wVoTgLxq3yiR2GaC+PezVT1IeSjnUMkORdJcEr7DCwP0LpJ5JPg2RFf1ZFa
#> Y+UG1JNEPXLbxJiHTYQKesvtgmFyN/g5grgAPNn4JYyRGzcwS41WJiAl2oolFPLC
#> nA+4TrVFKGXvlJwa/8GWqnIhT+bdnxYLcAELtnW9k3G72eRHkLT1rd09SMu5+TOn
#> UyH0woN1zC208/AWRPhBS8stZyPlqXb0Nuq/qVaHXyJKUQh179UXG5b88ruaLl28
#> wLuCTbW6xFikTf/VNwJpQbxzjDuz3ED/+aQR28KGfrbN0AdoGH7a5dX6s44mAs1e
#> ru+UPi6yhisHJ7tQ+cfCqB4y5r69lYXs3/H3805mGrD5RZQi+dVHU8nfQWhWRWFN
#> jYsJaSNSf9N50aD50kLfkM9dBndVZPOcypD2mLYmle4wDnMZBx2Fh6+NAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFFmOAdOaKBZiBWlXeuZy
#> 9w4woAnwMB8GA1UdIwQYMBaAFFmOAdOaKBZiBWlXeuZy9w4woAnwMA0GCSqGSIb3
#> DQEBCwUAA4ICAQCFRiK1WdGYTdh56Us7l2VYNhE8qs/IBKrQGCgJW4RYbsCNjt2/
#> oV6CYlWXIrP23IuK3ZckuYaB14T5/bSqXHxhvAM2LQF48VImvFJEtl1ZdQde64fi
#> ekFvgx7Ucfm/SjHahNqil9L7rNRDm0i0ZqlZp2fuZGdbQGPMaoKua1lvlyb1vcJ9
#> SrTntkVMKTIVEYldMBhinwfsvwGDTiWdfH4Sa8V4MHzcsjMx0810XClp002Z7hCP
#> i/s1Mg7YlJQ7vxMey9qk9osXd0L/gRQBTmYKw8t67olPuaQdHNnH376hnC22PRsg
#> DcgoP1rb82q6ZKrRxIL3dcVI2mTdQ6gDDD9q/BXfERolrLcpR4/DxGPAGkzghIDi
#> RgWnBg/RnwDj0oe/5f7zocGbie7SyDKg5DWpSGpFVgtP+aRlKarHxVNbO/pQZ9JW
#> Xq6aPx6FlrA7MHrPxW8kgd/PqfAEBdsEvu9Iam2P1l5XuEQsoGQgxiO2vehx9vLx
#> mUzH7Nz68r0FCd+Yq2mrAsRQ70+6dNsthPrtF+Jzh55h24ahIMyYSDdhUSBqQEIw
#> nmp3aw4131OBHc3EDwpk1D0LRxPyXQZIwamJ0AG2wIjn85Hy3PpBDF24y4rf50nS
#> aVlyVuJK5E/BZgqTa+a1slT9Fl3S6wf3dnxg5SttSb2z3N2rqbFn5iyXrw==
#> -----END CERTIFICATE-----
#> ",""),rs=c(10407,-569260196,-2101849939,1516135306,-1943160957,1248893672,-286141495))'
```
