...
#> [1] "{\"time\":[\"2024-01-11 18:00:27\"],\"msg\":[\"1\"],\"pid\":[11868]}"
#> [1] "{\"time\":[\"2024-01-11 18:00:27\"],\"msg\":[\"2\"],\"pid\":[11862]}"
#> [1] "{\"time\":[\"2024-01-11 18:00:27\"],\"msg\":[\"3\"],\"pid\":[11860]}"
#> [1] "{\"time\":[\"2024-01-11 18:00:27\"],\"msg\":[\"4\"],\"pid\":[11864]}"
#> [1] "{\"time\":[\"2024-01-11 18:00:28\"],\"msg\":[\"5\"],\"pid\":[11864]}"
#> [1] "{\"time\":[\"2024-01-11 18:00:28\"],\"msg\":[\"6\"],\"pid\":[11868]}"
#> [1] "{\"time\":[\"2024-01-11 18:00:28\"],\"msg\":[\"7\"],\"pid\":[11860]}"
#> [1] "{\"time\":[\"2024-01-11 18:00:28\"],\"msg\":[\"8\"],\"pid\":[11862]}"
...
res <- lapply(res, call_aio)
for (r in res) print(r$data)
#> [1] "{\"time\":[\"2024-01-11 18:00:31\"],\"msg\":[\"1\"],\"pid\":[12137]}"
#> [1] "{\"time\":[\"2024-01-11 18:00:31\"],\"msg\":[\"2\"],\"pid\":[12139]}"
#> [1] "{\"time\":[\"2024-01-11 18:00:32\"],\"msg\":[\"3\"],\"pid\":[12137]}"
#> [1] "{\"time\":[\"2024-01-11 18:00:31\"],\"msg\":[\"4\"],\"pid\":[12145]}"
#> [1] "{\"time\":[\"2024-01-11 18:00:32\"],\"msg\":[\"5\"],\"pid\":[12145]}"
#> [1] "{\"time\":[\"2024-01-11 18:00:31\"],\"msg\":[\"6\"],\"pid\":[12142]}"
#> [1] "{\"time\":[\"2024-01-11 18:00:32\"],\"msg\":[\"7\"],\"pid\":[12142]}"
#> [1] "{\"time\":[\"2024-01-11 18:00:32\"],\"msg\":[\"8\"],\"pid\":[12139]}"
