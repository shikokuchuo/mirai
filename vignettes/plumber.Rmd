...
#> [1] "{\"time\":[\"2024-01-11 12:16:11\"],\"msg\":[\"1\"],\"pid\":[34995]}"
#> [1] "{\"time\":[\"2024-01-11 12:16:11\"],\"msg\":[\"2\"],\"pid\":[34987]}"
#> [1] "{\"time\":[\"2024-01-11 12:16:11\"],\"msg\":[\"3\"],\"pid\":[34992]}"
#> [1] "{\"time\":[\"2024-01-11 12:16:11\"],\"msg\":[\"4\"],\"pid\":[34989]}"
#> [1] "{\"time\":[\"2024-01-11 12:16:12\"],\"msg\":[\"5\"],\"pid\":[34989]}"
#> [1] "{\"time\":[\"2024-01-11 12:16:12\"],\"msg\":[\"6\"],\"pid\":[34987]}"
#> [1] "{\"time\":[\"2024-01-11 12:16:12\"],\"msg\":[\"7\"],\"pid\":[34992]}"
#> [1] "{\"time\":[\"2024-01-11 12:16:12\"],\"msg\":[\"8\"],\"pid\":[34995]}"
...
res <- lapply(res, call_aio)
for (r in res) print(r$data)
#> [1] "{\"time\":[\"2024-01-11 12:16:15\"],\"msg\":[\"1\"],\"pid\":[35264]}"
#> [1] "{\"time\":[\"2024-01-11 12:16:16\"],\"msg\":[\"2\"],\"pid\":[35269]}"
#> [1] "{\"time\":[\"2024-01-11 12:16:15\"],\"msg\":[\"3\"],\"pid\":[35266]}"
#> [1] "{\"time\":[\"2024-01-11 12:16:16\"],\"msg\":[\"4\"],\"pid\":[35264]}"
#> [1] "{\"time\":[\"2024-01-11 12:16:15\"],\"msg\":[\"5\"],\"pid\":[35269]}"
#> [1] "{\"time\":[\"2024-01-11 12:16:15\"],\"msg\":[\"6\"],\"pid\":[35272]}"
#> [1] "{\"time\":[\"2024-01-11 12:16:16\"],\"msg\":[\"7\"],\"pid\":[35272]}"
#> [1] "{\"time\":[\"2024-01-11 12:16:16\"],\"msg\":[\"8\"],\"pid\":[35266]}"
