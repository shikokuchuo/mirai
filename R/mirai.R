...
#'     issues.
#'
#'     Automatically passes the client TLS configuration generated by \code{\link{daemons}}
#'     for the specified compute profile i.e. when the 'tls' argument is not set.
#'     In this case, there is no need to further specify a 'tls' argument as part
#'     of '\code{...}'.
#'
#' @examples
#' if (interactive()) {
