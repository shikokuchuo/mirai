...
#'     or \code{\link{ssh_config}} is supplied then this is used to effect the
#'     daemon launch on the remote machine.
#'
...
#'     commands. For manual deployment, unescape the double quotes around the
#'     call to \code{"mirai::daemon()"}.
#'
#' @rdname launch_local
#' @export
#'
