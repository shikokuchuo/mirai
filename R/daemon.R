...
#'     \code{''}.
#' @param serial [default NULL] (optional) a custom serialization configuration
#'     generated by \code{\link{serial_config}}.
...
#'     dispatcher, which listens at the \sQuote{url} address. In this way,
...
#' @section Persistence:
#'
#'     The \sQuote{autoexit} argument governs persistence settings for the
...
activate_serial <- function(x)
  if (length(x)) next_config(refhook = eval(str2lang(x[[1]])), class = x[[2L]], vec = x[[3L]])
