...
#'   collect_pipe .context cv cv_value dial .dispatcher .interrupt
#'   is_error_value .keep listen lock .mark mclock msleep nng_error .online opt
#'   opt<- parse_url pipe_notify random reap recv recv_aio request send send_aio
