...
#'
#' @importFrom nanonext aio_collect aio_collect_ aio_data_ call_aio call_aio_
#'     .context cv cv_value dial is_error_value listen lock mclock msleep
#'     next_config nng_error opt opt<- parse_url pipe_notify random reap recv
