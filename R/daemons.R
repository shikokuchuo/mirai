...
#'     daemon processes should connect to. Switching the URL scheme to 'tls+tcp://'
#'     or 'wss://' automatically upgrades the connection to use TLS.
#'
...
#' daemons(0)
#'
#' # Launch 2 daemons on remotes 10.75.32.80 and 10.75.32.90 using SSH
#' # connecting back directly to the host URL over a TLS connection:
#' #
#' # daemons(url = 'tls+tcp://10.75.32.70:5555',
#' #         remote = ssh_config(c('ssh://10.75.32.80', 'ssh://10.75.32.90')),
#' #         dispatcher = FALSE)
#'
