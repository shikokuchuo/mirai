...
#'     directly to the relevant arguments of \code{\link{launch_remote}}. If
#'     launching remote nodes, the number of nodes is inferred from the length
#'     of 'args' and 'n' is disregarded if supplied.
#'
